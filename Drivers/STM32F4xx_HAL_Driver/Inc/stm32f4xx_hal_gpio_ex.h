...
#define GPIO_AF5_SPI3                                                          \
    ((uint8_t)0x05) /* SPI3/I2S3 Alternate Function mapping   */
#define GPIO_AF5_SPI4                                                          \
    ((uint8_t)0x05) /* SPI4 Alternate Function mapping        */
#define GPIO_AF5_SPI5                                                          \
    ((uint8_t)0x05) /* SPI5 Alternate Function mapping        */
#define GPIO_AF5_SPI6                                                          \
    ((uint8_t)0x05) /* SPI6 Alternate Function mapping        */
#define GPIO_AF5_I2S3ext                                                       \
    ((uint8_t)0x05) /* I2S3ext_SD Alternate Function mapping  */

/**
 * @brief   AF 6 selection
 */
#define GPIO_AF6_SPI3                                                          \
    ((uint8_t)0x06) /* SPI3/I2S3 Alternate Function mapping  */
#define GPIO_AF6_I2S2ext                                                       \
    ((uint8_t)0x06) /* I2S2ext_SD Alternate Function mapping */
#define GPIO_AF6_SAI1                                                          \
    ((uint8_t)0x06) /* SAI1 Alternate Function mapping       */
...
#define GPIO_AF7_I2S3ext                                                       \
    ((uint8_t)0x07) /* I2S3ext_SD Alternate Function mapping */
...
#define GPIO_AF12_FMC                                                          \
    ((uint8_t)0x0C) /* FMC Alternate Function mapping                      */
#define GPIO_AF12_OTG_HS_FS                                                    \
    ((uint8_t)0x0C) /* OTG HS configured in FS, Alternate Function mapping */
#define GPIO_AF12_SDIO                                                         \
    ((uint8_t)0x0C) /* SDIO Alternate Function mapping                     */
 ...
 */
#define GPIO_AF5_I2S3ext                                                       \
    GPIO_AF5_SPI3 /* I2S3ext_SD Alternate Function mapping  */
 ...
 * @brief   AF 12 selection
 */
#define GPIO_AF12_FSMC                                                         \
    ((uint8_t)0x0C) /* FSMC Alternate Function mapping                     */
#define GPIO_AF12_OTG_HS_FS                                                    \
    ((uint8_t)0x0C) /* OTG HS configured in FS, Alternate Function mapping */
#define GPIO_AF12_SDIO                                                         \
    ((uint8_t)0x0C) /* SDIO Alternate Function mapping                     */
...
#define GPIO_AF5_SPI2                                                          \
    ((uint8_t)0x05) /* SPI2/I2S2 Alternate Function mapping   */
#define GPIO_AF5_SPI3                                                          \
    ((uint8_t)0x05) /* SPI3 Alternate Function mapping        */
#define GPIO_AF5_SPI4                                                          \
    ((uint8_t)0x05) /* SPI4 Alternate Function mapping        */
#define GPIO_AF5_I2S3ext                                                       \
    ((uint8_t)0x05) /* I2S3ext_SD Alternate Function mapping  */
...
#define GPIO_AF4_I2C2 ((uint8_t)0x04) /* I2C2 Alternate Function mapping    */
#define GPIO_AF4_I2C3 ((uint8_t)0x04) /* I2C3 Alternate Function mapping    */
#define GPIO_AF4_FMPI2C1                                                       \
    ((uint8_t)0x04) /* FMPI2C1 Alternate Function mapping */

/**
 * @brief   AF 5 selection
 */
#define GPIO_AF5_SPI1                                                          \
    ((uint8_t)0x05) /* SPI1/I2S1 Alternate Function mapping   */
#define GPIO_AF5_SPI2                                                          \
    ((uint8_t)0x05) /* SPI2/I2S2 Alternate Function mapping   */
#define GPIO_AF5_SPI3                                                          \
    ((uint8_t)0x05) /* SPI3/I2S3 Alternate Function mapping   */
#define GPIO_AF5_SPI4                                                          \
    ((uint8_t)0x05) /* SPI4/I2S4 Alternate Function mapping   */
#define GPIO_AF5_I2S3ext                                                       \
    ((uint8_t)0x05) /* I2S3ext_SD Alternate Function mapping  */
...
#define GPIO_AF6_SPI2                                                          \
    ((uint8_t)0x06) /* I2S2 Alternate Function mapping       */
#define GPIO_AF6_SPI3                                                          \
    ((uint8_t)0x06) /* SPI3/I2S3 Alternate Function mapping  */
#define GPIO_AF6_SPI4                                                          \
    ((uint8_t)0x06) /* SPI4/I2S4 Alternate Function mapping  */
#define GPIO_AF6_SPI5                                                          \
    ((uint8_t)0x06) /* SPI5/I2S5 Alternate Function mapping  */
#define GPIO_AF6_I2S2ext                                                       \
    ((uint8_t)0x06) /* I2S2ext_SD Alternate Function mapping */
...
#define GPIO_AF7_SPI3                                                          \
    ((uint8_t)0x07) /* SPI3/I2S3 Alternate Function mapping  */
#define GPIO_AF7_USART1                                                        \
    ((uint8_t)0x07) /* USART1 Alternate Function mapping     */
#define GPIO_AF7_USART2                                                        \
    ((uint8_t)0x07) /* USART2 Alternate Function mapping     */
...
#define GPIO_AF9_I2C2 ((uint8_t)0x09)  /* I2C2 Alternate Function mapping    */
#define GPIO_AF9_I2C3 ((uint8_t)0x09)  /* I2C3 Alternate Function mapping    */
#define GPIO_AF9_FMPI2C1                                                       \
    ((uint8_t)0x09)                   /* FMPI2C1 Alternate Function mapping */
#define GPIO_AF9_CAN1 ((uint8_t)0x09) /* CAN1 Alternate Function mapping    */
...
#define GPIO_AF6_DFSDM1                                                        \
    ((uint8_t)0x06) /* DFSDM1 Alternate Function mapping     */
#define GPIO_AF6_DFSDM2                                                        \
    ((uint8_t)0x06) /* DFSDM2 Alternate Function mapping     */
/**
 * @brief   AF 7 selection
 */
#define GPIO_AF7_SPI3                                                          \
    ((uint8_t)0x07) /* SPI3/I2S3 Alternate Function mapping  */
#define GPIO_AF7_SAI1                                                          \
    ((uint8_t)0x07) /* SAI1 Alternate Function mapping       */
#define GPIO_AF7_USART1                                                        \
    ((uint8_t)0x07) /* USART1 Alternate Function mapping     */
#define GPIO_AF7_USART2                                                        \
    ((uint8_t)0x07) /* USART2 Alternate Function mapping     */
...
#define GPIO_AF7_I2S3ext                                                       \
    ((uint8_t)0x07) /* I2S3ext_SD Alternate Function mapping */
#define GPIO_AF7_DFSDM2                                                        \
    ((uint8_t)0x07) /* DFSDM2 Alternate Function mapping     */
 ...
 */
#define GPIO_AF6_SPI2                                                          \
    ((uint8_t)0x06) /* SPI2/I2S2 Alternate Function mapping  */
#define GPIO_AF6_SPI3                                                          \
    ((uint8_t)0x06) /* SPI3/I2S3 Alternate Function mapping  */
#define GPIO_AF6_SPI4                                                          \
    ((uint8_t)0x06) /* SPI4 Alternate Function mapping       */
#define GPIO_AF6_SAI1                                                          \
    ((uint8_t)0x06) /* SAI1 Alternate Function mapping       */
...
#define GPIO_AF7_UART5                                                         \
    ((uint8_t)0x07) /* UART5 Alternate Function mapping      */
#define GPIO_AF7_SPI2                                                          \
    ((uint8_t)0x07) /* SPI2/I2S2 Alternate Function mapping  */
#define GPIO_AF7_SPI3                                                          \
    ((uint8_t)0x07) /* SPI3/I2S3 Alternate Function mapping  */
#define GPIO_AF7_SPDIFRX                                                       \
    ((uint8_t)0x07) /* SPDIFRX Alternate Function mapping      */
...
#define GPIO_AF8_SPDIFRX                                                       \
    ((uint8_t)0x08)                   /* SPDIFRX Alternate Function mapping  */
...
#if defined(STM32F446xx) || defined(STM32F412Zx) || defined(STM32F413xx) ||    \
    defined(STM32F423xx)
#define GPIO_GET_INDEX(__GPIOx__)                                              \
    (uint8_t)(((__GPIOx__) == (GPIOA))   ? 0U                                  \
              : ((__GPIOx__) == (GPIOB)) ? 1U                                  \
...
/** @defgroup GPIOEx_IS_Alternat_function_selection GPIO Check Alternate
 * Function
 * @{
 */
/*------------------------- STM32F429xx/STM32F439xx---------------------------*/
...
#if defined(STM32F401xC) || defined(STM32F401xE)
#define IS_GPIO_AF(AF)                                                         \
    (((AF) == GPIO_AF0_RTC_50Hz) || ((AF) == GPIO_AF12_SDIO) ||                \
     ((AF) == GPIO_AF0_MCO) || ((AF) == GPIO_AF0_TAMPER) ||                    \
     ((AF) == GPIO_AF0_SWJ) || ((AF) == GPIO_AF0_TRACE) ||                     \
     ((AF) == GPIO_AF1_TIM1) || ((AF) == GPIO_AF1_TIM2) ||                     \
     ((AF) == GPIO_AF2_TIM3) || ((AF) == GPIO_AF2_TIM4) ||                     \
