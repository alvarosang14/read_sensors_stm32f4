 ...
 * @{
 */
/* Array used to get the DMA stream register offset versus stream index
 * LL_DMA_STREAM_x */
...
typedef struct {
    uint32_t
        PeriphOrM2MSrcAddress; /*!< Specifies the peripheral base address for
    ...
    uint32_t
        PeriphOrM2MSrcDataSize; /*!< Specifies the Peripheral data size
    ...
    uint32_t
        Channel; /*!< Specifies the peripheral channel.
                      This parameter can be a value of @ref DMA_LL_EC_CHANNEL

                      This feature can be modified afterwards using unitary
                    function @ref LL_DMA_SetChannelSelection(). */
    ...
    uint32_t
        Priority; /*!< Specifies the channel priority level.
                       ...
                       This feature can be modified afterwards using unitary
                     function @ref LL_DMA_SetStreamPriorityLevel(). */

    uint32_t FIFOMode; /*!< Specifies if the FIFO mode or Direct mode will be
                          used for the specified stream. This parameter can be a
                          value of @ref DMA_LL_FIFOMODE
                            @note The Direct mode (FIFO mode disabled) cannot be
                          used if the memory-to-memory data transfer is
                          configured on the selected stream

                            This feature can be modified afterwards using
                          unitary functions @ref LL_DMA_EnableFifoMode() or @ref
                          LL_DMA_EnableFifoMode() . */

    uint32_t
        FIFOThreshold; /*!< Specifies the FIFO threshold level.
                            This parameter can be a value of @ref
                          DMA_LL_EC_FIFOTHRESHOLD

                            This feature can be modified afterwards using
                          unitary function @ref LL_DMA_SetFIFOThreshold(). */

    uint32_t
        MemBurst; /*!< Specifies the Burst transfer configuration for the memory
                     transfers. It specifies the amount of data to be
                     transferred in a single non interruptible transaction. This
                     parameter can be a value of @ref DMA_LL_EC_MBURST
                       @note The burst mode is possible only if the address
                     Increment mode is enabled.

                       This feature can be modified afterwards using unitary
                     function @ref LL_DMA_SetMemoryBurstxfer(). */

    uint32_t
        PeriphBurst; /*!< Specifies the Burst transfer configuration for the
                        peripheral transfers. It specifies the amount of data to
                        be transferred in a single non interruptible
                          transaction.
                        ...
                        Increment mode is enabled.
                          ...
                          This feature can be modified afterwards using unitary
                        function @ref LL_DMA_SetPeriphBurstxfer(). */
 ...
 * @{
 */
#define LL_DMA_DOUBLEBUFFER_MODE_DISABLE                                       \
    0x00000000U /*!< Disable double buffering mode */
#define LL_DMA_DOUBLEBUFFER_MODE_ENABLE                                        \
    DMA_SxCR_DBM /*!< Enable double buffering mode  */
/**
 * @}
 */
...
#define LL_DMA_PERIPH_INCREMENT                                                \
    DMA_SxCR_PINC /*!< Peripheral increment mode Enable  */
/**
 * @}
 */
...
#define LL_DMA_MEMORY_INCREMENT                                                \
    DMA_SxCR_MINC /*!< Memory increment mode Enable  */
/**
 * @}
 */
...
#define LL_DMA_PDATAALIGN_HALFWORD                                             \
    DMA_SxCR_PSIZE_0 /*!< Peripheral data alignment : HalfWord */
#define LL_DMA_PDATAALIGN_WORD                                                 \
    DMA_SxCR_PSIZE_1 /*!< Peripheral data alignment : Word     */
/**
 * @}
 */
...
#define LL_DMA_MDATAALIGN_HALFWORD                                             \
    DMA_SxCR_MSIZE_0 /*!< Memory data alignment : HalfWord */
#define LL_DMA_MDATAALIGN_WORD                                                 \
    DMA_SxCR_MSIZE_1 /*!< Memory data alignment : Word     */
/**
 * @}
 */
...
#define LL_DMA_OFFSETSIZE_FIXEDTO4                                             \
    DMA_SxCR_PINCOS /*!< Peripheral increment offset size is fixed to 4        \
                       (32-bit alignment) */
/**
 * @}
 */
...
#define LL_DMA_CHANNEL_11                                                      \
    (DMA_SxCR_CHSEL_3 | DMA_SxCR_CHSEL_1 |                                     \
     DMA_SxCR_CHSEL_0) /* Select Channel11 of DMA Instance */
#define LL_DMA_CHANNEL_12                                                      \
    (DMA_SxCR_CHSEL_3 | DMA_SxCR_CHSEL_2) /* Select Channel12 of DMA Instance  \
                                           */
#define LL_DMA_CHANNEL_13                                                      \
    (DMA_SxCR_CHSEL_3 | DMA_SxCR_CHSEL_2 |                                     \
     DMA_SxCR_CHSEL_0) /* Select Channel13 of DMA Instance */
#define LL_DMA_CHANNEL_14                                                      \
    (DMA_SxCR_CHSEL_3 | DMA_SxCR_CHSEL_2 |                                     \
     DMA_SxCR_CHSEL_1) /* Select Channel14 of DMA Instance */
 ...
 * @{
 */
#define LL_DMA_MBURST_SINGLE                                                   \
    0x00000000U /*!< Memory burst single transfer configuration */
...
#define LL_DMA_MBURST_INC16                                                    \
    (DMA_SxCR_MBURST_0 | DMA_SxCR_MBURST_1) /*!< Memory burst of 16 beats      \
 ...
 * @{
 */
#define LL_DMA_PBURST_SINGLE                                                   \
    0x00000000U /*!< Peripheral burst single transfer configuration */
...
#define LL_DMA_PBURST_INC16                                                    \
    (DMA_SxCR_PBURST_0 | DMA_SxCR_PBURST_1) /*!< Peripheral burst of 16 beats  \
                                               transfer configuration */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_DMA_FIFOMODE_DISABLE                                                \
    0x00000000U /*!< FIFO mode disable (direct mode is enabled) */
...
#define LL_DMA_FIFOSTATUS_75_100                                               \
    (DMA_SxFCR_FS_1 | DMA_SxFCR_FS_0)          /*!< 3/4 < fifo_level < full */
#define LL_DMA_FIFOSTATUS_EMPTY DMA_SxFCR_FS_2 /*!< FIFO is empty           */
#define LL_DMA_FIFOSTATUS_FULL                                                 \
    (DMA_SxFCR_FS_2 | DMA_SxFCR_FS_0) /*!< FIFO is full            */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_DMA_FIFOTHRESHOLD_1_4                                               \
    0x00000000U /*!< FIFO threshold 1 quart full configuration  */
#define LL_DMA_FIFOTHRESHOLD_1_2                                               \
    DMA_SxFCR_FTH_0 /*!< FIFO threshold half full configuration     */
#define LL_DMA_FIFOTHRESHOLD_3_4                                               \
    DMA_SxFCR_FTH_1 /*!< FIFO threshold 3 quarts full configuration */
#define LL_DMA_FIFOTHRESHOLD_FULL                                              \
    DMA_SxFCR_FTH /*!< FIFO threshold full configuration          */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_DMA_CURRENTTARGETMEM0                                               \
    0x00000000U /*!< Set CurrentTarget Memory to Memory 0  */
#define LL_DMA_CURRENTTARGETMEM1                                               \
    DMA_SxCR_CT /*!< Set CurrentTarget Memory to Memory 1  */
/**
 * @}
 */
...
#define __LL_DMA_GET_STREAM(__STREAM_INSTANCE__)                               \
    (((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA1_Stream0))             \
         ? LL_DMA_STREAM_0                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA2_Stream0))           \
         ? LL_DMA_STREAM_0                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA1_Stream1))           \
         ? LL_DMA_STREAM_1                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA2_Stream1))           \
         ? LL_DMA_STREAM_1                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA1_Stream2))           \
         ? LL_DMA_STREAM_2                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA2_Stream2))           \
         ? LL_DMA_STREAM_2                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA1_Stream3))           \
         ? LL_DMA_STREAM_3                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA2_Stream3))           \
         ? LL_DMA_STREAM_3                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA1_Stream4))           \
         ? LL_DMA_STREAM_4                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA2_Stream4))           \
         ? LL_DMA_STREAM_4                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA1_Stream5))           \
         ? LL_DMA_STREAM_5                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA2_Stream5))           \
         ? LL_DMA_STREAM_5                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA1_Stream6))           \
         ? LL_DMA_STREAM_6                                                     \
     : ((uint32_t)(__STREAM_INSTANCE__) == ((uint32_t)DMA2_Stream6))           \
         ? LL_DMA_STREAM_6                                                     \
         : LL_DMA_STREAM_7)
...
__STATIC_INLINE uint32_t LL_DMA_IsEnabledStream(DMA_TypeDef *DMAx,
                                                uint32_t Stream) {
    return (
        READ_BIT(((DMA_Stream_TypeDef *)((uint32_t)((uint32_t)DMAx +
                                                    STREAM_OFFSET_TAB[Stream])))
                     ->CR,
 ...
 *         @arg @ref LL_DMA_MODE_NORMAL or @ref LL_DMA_MODE_CIRCULAR  or @ref
 *LL_DMA_MODE_PFCTRL
...
LL_DMA_SetMemoryBurstxfer(DMA_TypeDef *DMAx, uint32_t Stream, uint32_t Mburst) {
    MODIFY_REG(((DMA_Stream_TypeDef *)((uint32_t)((uint32_t)DMAx +
                                                  STREAM_OFFSET_TAB[Stream])))
                   ->CR,
 ...
 */
__STATIC_INLINE void
LL_DMA_SetPeriphBurstxfer(DMA_TypeDef *DMAx, uint32_t Stream, uint32_t Pburst) {
    MODIFY_REG(((DMA_Stream_TypeDef *)((uint32_t)((uint32_t)DMAx +
                                                  STREAM_OFFSET_TAB[Stream])))
                   ->CR,
...
/**
 * @brief Set Current target (only in double buffer mode) to Memory 1 or Memory
 * 0.
...
__STATIC_INLINE uint32_t LL_DMA_GetMemoryAddress(DMA_TypeDef *DMAx,
                                                 uint32_t Stream) {
    return (
        READ_REG(((DMA_Stream_TypeDef *)((uint32_t)((uint32_t)DMAx +
                                                    STREAM_OFFSET_TAB[Stream])))
                     ->M0AR));
}
 ...
 */
__STATIC_INLINE void
LL_DMA_SetMemory1Address(DMA_TypeDef *DMAx, uint32_t Stream, uint32_t Address) {
    WRITE_REG(((DMA_Stream_TypeDef *)((uint32_t)((uint32_t)DMAx +
                                                 STREAM_OFFSET_TAB[Stream])))
                  ->M1AR,
              Address);
...
uint32_t LL_DMA_Init(DMA_TypeDef *DMAx, uint32_t Stream,
