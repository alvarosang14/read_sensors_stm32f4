...
#define EXTI_LINE_17                                                           \
    (EXTI_CONFIG | 0x11u) /*!< External interrupt line 17 Connected to the RTC \
                             Alarm event */
...
#else
#define EXTI_LINE_18                                                           \
    (EXTI_RESERVED | 0x12u) /*!< No interrupt supported in this line */
#endif                      /* EXTI_IMR_IM18 */
...
#else
#define EXTI_LINE_19                                                           \
    (EXTI_RESERVED | 0x13u) /*!< No interrupt supported in this line */
#endif                      /* EXTI_IMR_IM19 */
#if defined(EXTI_IMR_IM20)
#define EXTI_LINE_20                                                           \
    (EXTI_CONFIG | 0x14u) /*!< External interrupt line 20 Connected to the USB \
                             OTG HS (configured in FS) Wakeup event  */
#else
#define EXTI_LINE_20                                                           \
    (EXTI_RESERVED | 0x14u) /*!< No interrupt supported in this line */
#endif                      /* EXTI_IMR_IM20 */
#define EXTI_LINE_21                                                           \
    (EXTI_CONFIG | 0x15u) /*!< External interrupt line 21 Connected to the RTC \
                             Tamper and Time Stamp events */
#define EXTI_LINE_22                                                           \
    (EXTI_CONFIG | 0x16u) /*!< External interrupt line 22 Connected to the RTC \
                             Wakeup event */
#if defined(EXTI_IMR_IM23)
#define EXTI_LINE_23                                                           \
    (EXTI_CONFIG | 0x17u) /*!< External interrupt line 23 Connected to the     \
                             LPTIM1 asynchronous event */
#endif                    /* EXTI_IMR_IM23 */
