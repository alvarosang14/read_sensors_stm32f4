...
typedef struct {
    ...
    uint32_t FIFOMode; /*!< Specifies if the FIFO mode or Direct mode will be
                          ...
                          value of @ref DMA_FIFO_direct_mode
    ...
    uint32_t PeriphBurst; /*!< Specifies the Burst transfer configuration for
                             the peripheral transfers. It specifies the amount
                             of data to be transferred in a single non
                             interruptible transaction. This parameter can be a
                             value of @ref DMA_Peripheral_burst
...
typedef struct __DMA_HandleTypeDef {
    ...
    void (*XferM1CpltCallback)(
        struct __DMA_HandleTypeDef
            *hdma); /*!< DMA transfer complete Memory1 callback */
...
#define HAL_DMA_ERROR_FE                                                       \
    0x00000002U /*!< FIFO error                             */
#define HAL_DMA_ERROR_DME                                                      \
    0x00000004U /*!< Direct Mode error                      */
...
#define HAL_DMA_ERROR_NO_XFER                                                  \
    0x00000080U /*!< Abort requested with no Xfer ongoing   */
...
#define DMA_MEMORY_TO_MEMORY                                                   \
    ((uint32_t)DMA_SxCR_DIR_1) /*!< Memory to memory direction     */
/**
 * @}
 */
...
#define DMA_PINC_ENABLE                                                        \
    ((uint32_t)DMA_SxCR_PINC)        /*!< Peripheral increment mode enable  */
...
#define DMA_MINC_ENABLE                                                        \
    ((uint32_t)DMA_SxCR_MINC)        /*!< Memory increment mode enable  */
...
#define DMA_PDATAALIGN_WORD                                                    \
    ((uint32_t)DMA_SxCR_PSIZE_1) /*!< Peripheral data alignment: Word     */
/**
 * @}
 */
...
#define DMA_MDATAALIGN_WORD                                                    \
    ((uint32_t)DMA_SxCR_MSIZE_1) /*!< Memory data alignment: Word     */
/**
 * @}
 */
...
#define DMA_CIRCULAR                                                           \
    ((uint32_t)DMA_SxCR_CIRC) /*!< Circular mode                */
#define DMA_PFCTRL                                                             \
    ((uint32_t)DMA_SxCR_PFCTRL) /*!< Peripheral flow control mode */
/**
 * @}
 */
...
#define DMA_PRIORITY_MEDIUM                                                    \
    ((uint32_t)DMA_SxCR_PL_0) /*!< Priority level: Medium    */
#define DMA_PRIORITY_HIGH                                                      \
    ((uint32_t)DMA_SxCR_PL_1) /*!< Priority level: High      */
#define DMA_PRIORITY_VERY_HIGH                                                 \
    ((uint32_t)DMA_SxCR_PL) /*!< Priority level: Very High */
/**
 * @}
 */
...
#define DMA_FIFOMODE_ENABLE                                                    \
    ((uint32_t)DMA_SxFCR_DMDIS) /*!< FIFO mode enable  */
/**
 * @}
 */
...
#define __HAL_DMA_GET_FS(__HANDLE__)                                           \
    (((__HANDLE__)->Instance->FCR & (DMA_SxFCR_FS)))
...
#define __HAL_DMA_DISABLE(__HANDLE__)                                          \
    ((__HANDLE__)->Instance->CR &= ~DMA_SxCR_EN)
...
#define __HAL_DMA_GET_TC_FLAG_INDEX(__HANDLE__)                                \
    (((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA1_Stream0))          \
         ? DMA_FLAG_TCIF0_4                                                    \
     : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA2_Stream0))        \
         ? DMA_FLAG_TCIF0_4                                                    \
     : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA1_Stream4))        \
         ? DMA_FLAG_TCIF0_4                                                    \
     : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA2_Stream4))        \
         ? DMA_FLAG_TCIF0_4                                                    \
     : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA1_Stream1))        \
         ? DMA_FLAG_TCIF1_5                                                    \
     : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA2_Stream1))        \
         ? DMA_FLAG_TCIF1_5                                                    \
     : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA1_Stream5))        \
         ? DMA_FLAG_TCIF1_5                                                    \
     : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA2_Stream5))        \
         ? DMA_FLAG_TCIF1_5                                                    \
     : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA1_Stream2))        \
         ? DMA_FLAG_TCIF2_6                                                    \
     : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA2_Stream2))        \
         ? DMA_FLAG_TCIF2_6                                                    \
     : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA1_Stream6))        \
         ? DMA_FLAG_TCIF2_6                                                    \
     : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA2_Stream6))        \
         ? DMA_FLAG_TCIF2_6                                                    \
         : DMA_FLAG_TCIF3_7)
...
#define __HAL_DMA_GET_FLAG(__HANDLE__, __FLAG__)                               \
    (((uint32_t)((__HANDLE__)->Instance) > (uint32_t)DMA2_Stream3)             \
         ? (DMA2->HISR & (__FLAG__))                                           \
     : ((uint32_t)((__HANDLE__)->Instance) > (uint32_t)DMA1_Stream7)           \
         ? (DMA2->LISR & (__FLAG__))                                           \
     : ((uint32_t)((__HANDLE__)->Instance) > (uint32_t)DMA1_Stream3)           \
         ? (DMA1->HISR & (__FLAG__))                                           \
         : (DMA1->LISR & (__FLAG__)))
...
/**
 * @brief  Check whether the specified DMA Stream interrupt is enabled or
 * disabled.
 * @param  __HANDLE__ DMA handle
 ...
 *
 * @retval The number of remaining data units in the current DMAy Streamx
 * transfer.
 */
...
/**
 * @brief  Returns the number of remaining data units in the current DMAy
 * Streamx transfer.
 * @param  __HANDLE__ DMA handle
 *
 * @retval The number of remaining data units in the current DMA Stream
 * transfer.
 */
