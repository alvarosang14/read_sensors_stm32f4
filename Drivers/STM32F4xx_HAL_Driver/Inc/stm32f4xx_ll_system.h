...
#define LL_SYSCFG_BANKMODE_BANK1                                               \
    (uint32_t)0x00000000 /*!< Flash Bank 1 base address mapped at 0x0800 0000  \
                          (AXI) and 0x0020 0000 (TCM) and Flash Bank 2 base                                                         \
                          address mapped at 0x0810 0000 (AXI) and 0x0030 0000  \
                          (TCM)*/
#define LL_SYSCFG_BANKMODE_BANK2                                               \
    SYSCFG_MEMRMP_UFB_MODE /*!< Flash Bank 2 base address mapped at 0x0800     \
                            0000 (AXI) and 0x0020 0000(TCM) and Flash Bank 1                                                              \
                            base address mapped at 0x0810 0000 (AXI) and       \
                            0x0030 0000(TCM) */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_SYSCFG_EXTI_PORTA                                                   \
    (uint32_t)0 /*!< EXTI PORT A                        */
#define LL_SYSCFG_EXTI_PORTB                                                   \
    (uint32_t)1 /*!< EXTI PORT B                        */
#define LL_SYSCFG_EXTI_PORTC                                                   \
    (uint32_t)2 /*!< EXTI PORT C                        */
#define LL_SYSCFG_EXTI_PORTD                                                   \
    (uint32_t)3 /*!< EXTI PORT D                        */
#define LL_SYSCFG_EXTI_PORTE                                                   \
    (uint32_t)4 /*!< EXTI PORT E                        */
#if defined(GPIOF)
#define LL_SYSCFG_EXTI_PORTF                                                   \
    (uint32_t)5 /*!< EXTI PORT F                        */
#endif          /* GPIOF */
#if defined(GPIOG)
#define LL_SYSCFG_EXTI_PORTG                                                   \
    (uint32_t)6 /*!< EXTI PORT G                        */
#endif          /* GPIOG */
#define LL_SYSCFG_EXTI_PORTH                                                   \
    (uint32_t)7 /*!< EXTI PORT H                        */
#if defined(GPIOI)
#define LL_SYSCFG_EXTI_PORTI                                                   \
    (uint32_t)8 /*!< EXTI PORT I                        */
#endif          /* GPIOI */
#if defined(GPIOJ)
#define LL_SYSCFG_EXTI_PORTJ                                                   \
    (uint32_t)9 /*!< EXTI PORT J                        */
#endif          /* GPIOJ */
#if defined(GPIOK)
#define LL_SYSCFG_EXTI_PORTK                                                   \
    (uint32_t)10 /*!< EXTI PORT k                        */
#endif           /* GPIOK */
/**
 * @}
 */
...
#define LL_SYSCFG_EXTI_LINE0                                                   \
    (uint32_t)(0x000FU << 16 | 0) /*!< EXTI_POSITION_0  | EXTICR[0] */
#define LL_SYSCFG_EXTI_LINE1                                                   \
    (uint32_t)(0x00F0U << 16 | 0) /*!< EXTI_POSITION_4  | EXTICR[0] */
#define LL_SYSCFG_EXTI_LINE2                                                   \
    (uint32_t)(0x0F00U << 16 | 0) /*!< EXTI_POSITION_8  | EXTICR[0] */
#define LL_SYSCFG_EXTI_LINE3                                                   \
    (uint32_t)(0xF000U << 16 | 0) /*!< EXTI_POSITION_12 | EXTICR[0] */
#define LL_SYSCFG_EXTI_LINE4                                                   \
    (uint32_t)(0x000FU << 16 | 1) /*!< EXTI_POSITION_0  | EXTICR[1] */
#define LL_SYSCFG_EXTI_LINE5                                                   \
    (uint32_t)(0x00F0U << 16 | 1) /*!< EXTI_POSITION_4  | EXTICR[1] */
#define LL_SYSCFG_EXTI_LINE6                                                   \
    (uint32_t)(0x0F00U << 16 | 1) /*!< EXTI_POSITION_8  | EXTICR[1] */
#define LL_SYSCFG_EXTI_LINE7                                                   \
    (uint32_t)(0xF000U << 16 | 1) /*!< EXTI_POSITION_12 | EXTICR[1] */
#define LL_SYSCFG_EXTI_LINE8                                                   \
    (uint32_t)(0x000FU << 16 | 2) /*!< EXTI_POSITION_0  | EXTICR[2] */
#define LL_SYSCFG_EXTI_LINE9                                                   \
    (uint32_t)(0x00F0U << 16 | 2) /*!< EXTI_POSITION_4  | EXTICR[2] */
#define LL_SYSCFG_EXTI_LINE10                                                  \
    (uint32_t)(0x0F00U << 16 | 2) /*!< EXTI_POSITION_8  | EXTICR[2] */
#define LL_SYSCFG_EXTI_LINE11                                                  \
    (uint32_t)(0xF000U << 16 | 2) /*!< EXTI_POSITION_12 | EXTICR[2] */
#define LL_SYSCFG_EXTI_LINE12                                                  \
    (uint32_t)(0x000FU << 16 | 3) /*!< EXTI_POSITION_0  | EXTICR[3] */
#define LL_SYSCFG_EXTI_LINE13                                                  \
    (uint32_t)(0x00F0U << 16 | 3) /*!< EXTI_POSITION_4  | EXTICR[3] */
#define LL_SYSCFG_EXTI_LINE14                                                  \
    (uint32_t)(0x0F00U << 16 | 3) /*!< EXTI_POSITION_8  | EXTICR[3] */
#define LL_SYSCFG_EXTI_LINE15                                                  \
    (uint32_t)(0xF000U << 16 | 3) /*!< EXTI_POSITION_12 | EXTICR[3] */
/**
 * @}
 */
...
#define LL_SYSCFG_TIMBREAK_LOCKUP                                              \
    SYSCFG_CFGR2_LOCKUP_LOCK /*!< Enables and locks the LOCKUP output of       \
                             CortexM4 with Break Input of TIM1/8 */
#define LL_SYSCFG_TIMBREAK_PVD                                                 \
    SYSCFG_CFGR2_PVD_LOCK /*!< Enables and locks the PVD connection with       \
                          TIM1/8 Break Input and also the PVDE and PLS bits of                                             \
...
#define LL_SYSCFG_DFSDM1_DataIn0_PAD                                           \
    (uint32_t)((SYSCFG_MCHDLYCR_DFSDM1D0SEL << 16) | 0x00000000)
#define LL_SYSCFG_DFSDM1_DataIn0_DM                                            \
    (uint32_t)((SYSCFG_MCHDLYCR_DFSDM1D0SEL << 16) |                           \
               SYSCFG_MCHDLYCR_DFSDM1D0SEL)
#define LL_SYSCFG_DFSDM2_DataIn0_PAD                                           \
    (uint32_t)((SYSCFG_MCHDLYCR_DFSDM2D0SEL << 16) | 0x00000000)
#define LL_SYSCFG_DFSDM2_DataIn0_DM                                            \
    (uint32_t)((SYSCFG_MCHDLYCR_DFSDM2D0SEL << 16) |                           \
...
#define LL_SYSCFG_DFSDM1_DataIn2_PAD                                           \
    (uint32_t)((SYSCFG_MCHDLYCR_DFSDM1D2SEL << 16) | 0x00000000)
#define LL_SYSCFG_DFSDM1_DataIn2_DM                                            \
    (uint32_t)((SYSCFG_MCHDLYCR_DFSDM1D2SEL << 16) |                           \
               SYSCFG_MCHDLYCR_DFSDM1D2SEL)
#define LL_SYSCFG_DFSDM2_DataIn2_PAD                                           \
    (uint32_t)((SYSCFG_MCHDLYCR_DFSDM2D2SEL << 16) | 0x00000000)
#define LL_SYSCFG_DFSDM2_DataIn2_DM                                            \
    (uint32_t)((SYSCFG_MCHDLYCR_DFSDM2D2SEL << 16) |                           \
               SYSCFG_MCHDLYCR_DFSDM2D2SEL)
/**
 * @}
 */
/** @defgroup SYSTEM_LL_DFSDM1_TIM4OC2_BitstreamDistribution  SYSCFG MCHDLY
 * DFSDM1CK02SEL
 * @{
 */
 ...
 * @}
 */
/** @defgroup SYSTEM_LL_DFSDM1_TIM4OC1_BitstreamDistribution  SYSCFG MCHDLY
 * DFSDM1CK13SEL
 * @{
 */
 ...
 * @}
 */
/** @defgroup SYSTEM_LL_DFSDM2_TIM3OC4_BitstreamDistribution  SYSCFG MCHDLY
 * DFSDM2CK04SEL
 * @{
 */
 ...
 * @}
 */
/** @defgroup SYSTEM_LL_DFSDM2_TIM3OC3_BitstreamDistribution  SYSCFG MCHDLY
 * DFSDM2CK15SEL
 * @{
 */
 ...
 * @}
 */
/** @defgroup SYSTEM_LL_DFSDM2_TIM3OC2_BitstreamDistribution  SYSCFG MCHDLY
 * DFSDM2CK26SEL
 * @{
 */
 ...
 * @}
 */
/** @defgroup SYSTEM_LL_DFSDM2_TIM3OC1_BitstreamDistribution  SYSCFG MCHDLY
 * DFSDM2CK37SEL
 * @{
 */
...
#define LL_DBGMCU_TRACE_SYNCH_SIZE1                                            \
    (DBGMCU_CR_TRACE_IOEN |                                                    \
     DBGMCU_CR_TRACE_MODE_0) /*!< TRACE pin assignment for Synchronous Mode    \
                                with a TRACEDATA size of 1 */
#define LL_DBGMCU_TRACE_SYNCH_SIZE2                                            \
    (DBGMCU_CR_TRACE_IOEN |                                                    \
     DBGMCU_CR_TRACE_MODE_1) /*!< TRACE pin assignment for Synchronous Mode    \
                                with a TRACEDATA size of 2 */
#define LL_DBGMCU_TRACE_SYNCH_SIZE4                                            \
    (DBGMCU_CR_TRACE_IOEN |                                                    \
     DBGMCU_CR_TRACE_MODE) /*!< TRACE pin assignment for Synchronous Mode with \
                              a TRACEDATA size of 4 */
/**
 * @}
 */
...
#define LL_DBGMCU_APB1_GRP1_WWDG_STOP                                          \
    DBGMCU_APB1_FZ_DBG_WWDG_STOP /*!< Debug Window Watchdog stopped when Core  \
                                    is halted */
#define LL_DBGMCU_APB1_GRP1_IWDG_STOP                                          \
    DBGMCU_APB1_FZ_DBG_IWDG_STOP /*!< Debug Independent Watchdog stopped when  \
                                    Core is halted */
#define LL_DBGMCU_APB1_GRP1_I2C1_STOP                                          \
    DBGMCU_APB1_FZ_DBG_I2C1_SMBUS_TIMEOUT /*!< I2C1 SMBUS timeout mode stopped \
                                             when Core is halted */
#define LL_DBGMCU_APB1_GRP1_I2C2_STOP                                          \
    DBGMCU_APB1_FZ_DBG_I2C2_SMBUS_TIMEOUT /*!< I2C2 SMBUS timeout mode stopped \
                                             when Core is halted */
#if defined(DBGMCU_APB1_FZ_DBG_I2C3_SMBUS_TIMEOUT)
#define LL_DBGMCU_APB1_GRP1_I2C3_STOP                                          \
    DBGMCU_APB1_FZ_DBG_I2C3_SMBUS_TIMEOUT /*!< I2C3 SMBUS timeout mode stopped \
                                             when Core is halted */
...
#define LL_DBGMCU_APB1_GRP1_I2C4_STOP                                          \
    DBGMCU_APB1_FZ_DBG_I2C4_SMBUS_TIMEOUT /*!< I2C4 SMBUS timeout mode stopped \
                                             when Core is halted */
...
#define LL_DBGMCU_APB2_GRP1_TIM10_STOP                                         \
    DBGMCU_APB2_FZ_DBG_TIM10_STOP /*!< TIM10 counter stopped when core is      \
                                     halted */
#endif                            /* DBGMCU_APB2_FZ_DBG_TIM10_STOP */
#define LL_DBGMCU_APB2_GRP1_TIM11_STOP                                         \
    DBGMCU_APB2_FZ_DBG_TIM11_STOP /*!< TIM11 counter stopped when core is      \
                                     halted */
/**
 * @}
 */
...
__STATIC_INLINE void LL_SYSCFG_SetTIMBreakInputs(uint32_t Break) {
    MODIFY_REG(SYSCFG->CFGR2, SYSCFG_CFGR2_LOCKUP_LOCK | SYSCFG_CFGR2_PVD_LOCK,
               Break);
}
...
#if defined(SYSCFG_MCHDLYCR_BSCKSEL)
/**
 * @brief  Select the DFSDM2 or TIM2_OC1 as clock source for the bitstream
 * clock.
 * @rmtoll SYSCFG_MCHDLYCR BSCKSEL
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DFSDM_SetBitstreamClockSourceSelection(uint32_t ClockSource) {
...
LL_SYSCFG_DFSDM_GetBitstreamClockSourceSelection(void) {
 ...
 * @rmtoll SYSCFG_MCHDLYCR DFSDM1CK02SEL
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DFSDM1_SetTIM4OC2BitStreamDistribution(uint32_t Source) {
 ...
 * @rmtoll SYSCFG_MCHDLYCR DFSDM1D2SEL
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_DFSDM1_GetTIM4OC2BitStreamDistribution(void) {
    return (
        uint32_t)(READ_BIT(SYSCFG->MCHDLYCR, SYSCFG_MCHDLYCR_DFSDM1CK02SEL));
}

/**
 * @brief  Select the distribution of the bitsream lock gated by TIM4 OC1
 * @rmtoll SYSCFG_MCHDLYCR DFSDM1CK13SEL
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DFSDM1_SetTIM4OC1BitStreamDistribution(uint32_t Source) {
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_DFSDM1_GetTIM4OC1BitStreamDistribution(void) {
    return (
        uint32_t)(READ_BIT(SYSCFG->MCHDLYCR, SYSCFG_MCHDLYCR_DFSDM1CK13SEL));
}
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DFSDM1_SetClockInSourceSelection(uint32_t ClockSource) {
 ...
 * @rmtoll SYSCFG_MCHDLYCR DFSDM1CKOSEL
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DFSDM1_SetClockOutSourceSelection(uint32_t ClockSource) {
 ...
 * @rmtoll SYSCFG_MCHDLYCR DFSDM2CK04SEL
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DFSDM2_SetTIM3OC4BitStreamDistribution(uint32_t Source) {
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_DFSDM2_GetTIM3OC4BitStreamDistribution(void) {
    return (
        uint32_t)(READ_BIT(SYSCFG->MCHDLYCR, SYSCFG_MCHDLYCR_DFSDM2CK04SEL));
}

/**
 * @brief  Select the distribution of the bitsream lock gated by TIM3 OC3
 * @rmtoll SYSCFG_MCHDLYCR DFSDM2CK15SEL
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DFSDM2_SetTIM3OC3BitStreamDistribution(uint32_t Source) {
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_DFSDM2_GetTIM3OC3BitStreamDistribution(void) {
    return (
        uint32_t)(READ_BIT(SYSCFG->MCHDLYCR, SYSCFG_MCHDLYCR_DFSDM2CK15SEL));
}

/**
 * @brief  Select the distribution of the bitsream lock gated by TIM3 OC2
 * @rmtoll SYSCFG_MCHDLYCR DFSDM2CK26SEL
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DFSDM2_SetTIM3OC2BitStreamDistribution(uint32_t Source) {
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_DFSDM2_GetTIM3OC2BitStreamDistribution(void) {
    return (
        uint32_t)(READ_BIT(SYSCFG->MCHDLYCR, SYSCFG_MCHDLYCR_DFSDM2CK26SEL));
}

/**
 * @brief  Select the distribution of the bitsream lock gated by TIM3 OC1
 * @rmtoll SYSCFG_MCHDLYCR DFSDM2CK37SEL
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DFSDM2_SetTIM3OC1BitStreamDistribution(uint32_t Source) {
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_DFSDM2_GetTIM3OC1BitStreamDistribution(void) {
    return (
        uint32_t)(READ_BIT(SYSCFG->MCHDLYCR, SYSCFG_MCHDLYCR_DFSDM2CK37SEL));
}
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DFSDM2_SetClockInSourceSelection(uint32_t ClockSource) {
 ...
 * @rmtoll SYSCFG_MCHDLYCR DFSDM2CKOSEL
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DFSDM2_SetClockOutSourceSelection(uint32_t ClockSource) {
...
/**
  ...
  * @note This field indicates the revision of the device.
          For example, it is read as RevA -> 0x1000, Cat 2 revZ -> 0x1001, rev1
  -> 0x1003, rev2 ->0x1007, revY -> 0x100F for STM32F405/407xx and
  STM32F415/417xx devices For example, it is read as RevA -> 0x1000, Cat 2 revY
  -> 0x1003, rev1 -> 0x1007, rev3 ->0x2001 for STM32F42xxx and STM32F43xxx
  devices For example, it is read as RevZ -> 0x1000, Cat 2 revA -> 0x1001 for
  STM32F401xB/C devices For example, it is read as RevA -> 0x1000, Cat 2 revZ ->
  0x1001 for STM32F401xD/E devices For example, it is read as RevA -> 0x1000 for
  STM32F411xx,STM32F413/423xx,STM32F469/423xx, STM32F446xx and STM32F410xx
  devices For example, it is read as RevZ -> 0x1001, Cat 2 revB -> 0x2000, revC
  -> 0x3000 for STM32F412xx devices
 ...
 *         DBGMCU_APB1_FZ      DBG_I2C1_SMBUS_TIMEOUT
 * LL_DBGMCU_APB1_GRP1_FreezePeriph\n DBGMCU_APB1_FZ      DBG_I2C2_SMBUS_TIMEOUT
 * LL_DBGMCU_APB1_GRP1_FreezePeriph\n DBGMCU_APB1_FZ      DBG_I2C3_SMBUS_TIMEOUT
 * LL_DBGMCU_APB1_GRP1_FreezePeriph\n DBGMCU_APB1_FZ      DBG_I2C4_SMBUS_TIMEOUT
 * LL_DBGMCU_APB1_GRP1_FreezePeriph\n DBGMCU_APB1_FZ      DBG_CAN1_STOP
 * LL_DBGMCU_APB1_GRP1_FreezePeriph\n DBGMCU_APB1_FZ      DBG_CAN2_STOP
 * LL_DBGMCU_APB1_GRP1_FreezePeriph\n DBGMCU_APB1_FZ      DBG_CAN3_STOP
 * LL_DBGMCU_APB1_GRP1_FreezePeriph
 ...
 * @rmtoll DBGMCU_APB1_FZ      DBG_TIM2_STOP
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBGMCU_APB1_FZ      DBG_TIM3_STOP
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBGMCU_APB1_FZ      DBG_TIM4_STOP
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBGMCU_APB1_FZ      DBG_TIM5_STOP
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBGMCU_APB1_FZ      DBG_TIM6_STOP
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBGMCU_APB1_FZ      DBG_TIM7_STOP
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBGMCU_APB1_FZ      DBG_TIM12_STOP
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBGMCU_APB1_FZ      DBG_TIM13_STOP
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBGMCU_APB1_FZ      DBG_TIM14_STOP
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBGMCU_APB1_FZ      DBG_LPTIM_STOP
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBGMCU_APB1_FZ      DBG_RTC_STOP
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBGMCU_APB1_FZ      DBG_WWDG_STOP
 ...
 * @rmtoll DBGMCU_APB2_FZ      DBG_TIM1_STOP
 * LL_DBGMCU_APB2_GRP1_UnFreezePeriph\n DBGMCU_APB2_FZ      DBG_TIM8_STOP
 * LL_DBGMCU_APB2_GRP1_UnFreezePeriph\n DBGMCU_APB2_FZ      DBG_TIM9_STOP
 * LL_DBGMCU_APB2_GRP1_UnFreezePeriph\n DBGMCU_APB2_FZ      DBG_TIM10_STOP
 * LL_DBGMCU_APB2_GRP1_UnFreezePeriph\n DBGMCU_APB2_FZ      DBG_TIM11_STOP
 * LL_DBGMCU_APB2_GRP1_UnFreezePeriph
 * @param  Periphs This parameter can be a combination of the following values:
 *         @arg @ref LL_DBGMCU_APB2_GRP1_TIM1_STOP
 *         @arg @ref LL_DBGMCU_APB2_GRP1_TIM8_STOP (*)
