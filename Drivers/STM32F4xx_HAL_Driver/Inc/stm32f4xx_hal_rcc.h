...
typedef struct {
    ...
    uint32_t
        APB1CLKDivider; /*!< The APB1 clock (PCLK1) divider. This clock is
                           derived from the AHB clock (HCLK). This parameter can
                           be a value of @ref RCC_APB1_APB2_Clock_Source */

    uint32_t
        APB2CLKDivider; /*!< The APB2 clock (PCLK2) divider. This clock is
                           derived from the AHB clock (HCLK). This parameter can
                           be a value of @ref RCC_APB1_APB2_Clock_Source */
...
#define RCC_SYSCLKSOURCE_STATUS_PLLRCLK                                        \
    ((uint32_t)(RCC_CFGR_SWS_0 |                                               \
                RCC_CFGR_SWS_1)) /*!< PLLR used as system clock */
/**
 * @}
 */
...
/** @defgroup RCC_AHB1_LowPower_Enable_Disable AHB1 Peripheral Low Power Enable
 * Disable
...
/** @defgroup RCC_APB1_LowPower_Enable_Disable APB1 Peripheral Low Power Enable
 * Disable
...
/** @defgroup RCC_APB2_LowPower_Enable_Disable APB2 Peripheral Low Power Enable
 * Disable
...
#define __HAL_RCC_HSI_CALIBRATIONVALUE_ADJUST(__HSICalibrationValue__)         \
    (MODIFY_REG(RCC->CR, RCC_CR_HSITRIM,                                       \
                (uint32_t)(__HSICalibrationValue__) << RCC_CR_HSITRIM_Pos))
/**
 * @}
 */
 ...
 * supported by this macro. User should request a transition to HSE Off first
 ...
 *            @arg RCC_HSE_OFF: turn OFF the HSE oscillator, HSERDY flag goes
 * low after 6 HSE oscillator clock cycles.
 ...
 * supported by this macro. User should request a transition to LSE Off first
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_LSE_OFF: turn OFF the LSE oscillator, LSERDY flag goes
 * low after 6 LSE oscillator clock cycles.
 ...
 *         Backup domain is reset using __HAL_RCC_BackupReset_RELEASE() macro,
 * or by a Power On Reset (POR).
 * @param  __RTCCLKSource__ specifies the RTC clock source.
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_RTCCLKSOURCE_NO_CLK : No clock selected as RTC
 * clock.
 *            @arg @ref RCC_RTCCLKSOURCE_LSE : LSE selected as RTC clock.
 *            @arg @ref RCC_RTCCLKSOURCE_LSI : LSI selected as RTC clock.
 *            @arg @ref RCC_RTCCLKSOURCE_HSE_DIVX HSE divided by X selected as
 * RTC clock (X can be retrieved thanks to @ref
...
#define __HAL_RCC_GET_RTC_HSE_PRESCALER()                                      \
    (READ_BIT(RCC->CFGR, RCC_CFGR_RTCPRE) | RCC_BDCR_RTCSEL)
 ...
 * source.
 *              - RCC_SYSCLKSOURCE_PLLRCLK: PLLR output is used as system clock
 * source. This parameter is available only for STM32F446xx devices.
 */
 ...
 * This parameter is available only for STM32F446xx devices.
 */
 ...
 *            @arg RCC_MCODIV_4: division by 4 applied to MCOx clock
 *            @arg RCC_MCODIV_5: division by 5 applied to MCOx clock
 * @note  For STM32F410Rx devices, to output I2SCLK clock on MCO2, you should
 * have at least one of the SPI clocks enabled (SPI1, SPI2 or SPI5).
 */
 ...
 * RCC_FLAG_PORRST, RCC_FLAG_SFTRST, RCC_FLAG_IWDGRST, RCC_FLAG_WWDGRST and
 * RCC_FLAG_LPWRRST.
 */
...
#define RCC_CR_HSION_BB                                                        \
    (PERIPH_BB_BASE + (RCC_CR_OFFSET * 32U) + (RCC_HSION_BIT_NUMBER * 4U))
/* Alias word address of CSSON bit */
#define RCC_CSSON_BIT_NUMBER 0x13U
#define RCC_CR_CSSON_BB                                                        \
    (PERIPH_BB_BASE + (RCC_CR_OFFSET * 32U) + (RCC_CSSON_BIT_NUMBER * 4U))
/* Alias word address of PLLON bit */
#define RCC_PLLON_BIT_NUMBER 0x18U
#define RCC_CR_PLLON_BB                                                        \
    (PERIPH_BB_BASE + (RCC_CR_OFFSET * 32U) + (RCC_PLLON_BIT_NUMBER * 4U))
...
#define RCC_BDCR_RTCEN_BB                                                      \
    (PERIPH_BB_BASE + (RCC_BDCR_OFFSET * 32U) + (RCC_RTCEN_BIT_NUMBER * 4U))
/* Alias word address of BDRST bit */
#define RCC_BDRST_BIT_NUMBER 0x10U
#define RCC_BDCR_BDRST_BB                                                      \
    (PERIPH_BB_BASE + (RCC_BDCR_OFFSET * 32U) + (RCC_BDRST_BIT_NUMBER * 4U))
...
#define RCC_CSR_LSION_BB                                                       \
    (PERIPH_BB_BASE + (RCC_CSR_OFFSET * 32U) + (RCC_LSION_BIT_NUMBER * 4U))
...
/** @defgroup RCC_IS_RCC_Definitions RCC Private macros to check input
 * parameters
 * @{
 */
