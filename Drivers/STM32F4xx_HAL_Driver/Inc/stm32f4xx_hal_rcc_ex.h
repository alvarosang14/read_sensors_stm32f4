...
typedef struct {
    ...
    uint32_t PLLN; /*!< PLLN: Multiplication factor for PLL VCO output clock.
                      ...
                      and Max_Data = 432 except for STM32F411xE devices where
                      the Min_Data = 192 */
    ...
    uint32_t PLLQ; /*!< PLLQ: Division factor for OTG FS, SDIO and RNG clocks.
                        This parameter must be a number between Min_Data = 2 and
                      Max_Data = 15    */
...
typedef struct {
    ...
    uint32_t PLLI2SN; /*!< Specifies the multiplication factor for PLLI2S VCO
                         output clock. This parameter must be a number between
    ...
    uint32_t PLLI2SQ; /*!< Specifies the division factor for SAI clock.
                           This parameter must be a number between Min_Data = 2
                         and Max_Data = 15. This parameter will be used only
                         when PLLI2S is selected as Clock Source SAI */

    uint32_t PLLI2SR; /*!< Specifies the division factor for I2S clock.
                           This parameter must be a number between Min_Data = 2
                         and Max_Data = 7. This parameter will be used only when
                         PLLI2S is selected as Clock Source I2S */
...
typedef struct {
    ...
    uint32_t PLLSAIP; /*!< Specifies division factor for OTG FS, SDIO and RNG
    ...
    uint32_t PLLSAIQ; /*!< Specifies the division factor for SAI clock.
                           This parameter must be a number between Min_Data = 2
                         and Max_Data = 15. This parameter will be used only
                         when PLLSAI is selected as Clock Source SAI */
...
typedef struct {
    ...
    RCC_PLLSAIInitTypeDef
        PLLSAI; /*!< PLL SAI structure parameters.
                     This parameter will be used only when PLLI2S is selected as
    ...
    uint32_t
        PLLI2SDivQ; /*!< Specifies the PLLI2S division factor for SAI1 clock.
                       ...
                       and Max_Data = 32 This parameter will be used only when
    ...
    uint32_t I2sApb1ClockSelection; /*!< Specifies I2S APB1 Clock Source
                                     Selection. This parameter can be a value of
                                     @ref RCCEx_I2SAPB1_Clock_Source */

    uint32_t I2sApb2ClockSelection; /*!< Specifies I2S APB2 Clock Source
                                     Selection. This parameter can be a value of
                                     @ref RCCEx_I2SAPB2_Clock_Source */
    ...
    uint32_t Fmpi2c1ClockSelection; /*!< Specifies FMPI2C1 Clock Source
                                       Selection. This parameter can be a value
                                       of @ref RCCEx_FMPI2C1_Clock_Source */

    uint32_t SpdifClockSelection; /*!< Specifies SPDIFRX Clock Source Selection.
                                     This parameter can be a value of @ref
                                     RCCEx_SPDIFRX_Clock_Source */

    uint32_t Clk48ClockSelection; /*!< Specifies CLK48 Clock Selection this
                                    clock used OTG FS, SDIO and RNG clocks. This
...
typedef struct {
    ...
    uint32_t PLLDivR; /*!< Specifies the PLL division factor for SAI1 clock.
                           This parameter must be a number between Min_Data = 1
                         and Max_Data = 32 This parameter will be used only when
                         PLL is selected as Clock Source SAI */
    ...
    uint32_t SaiAClockSelection; /*!< Specifies SAI1_A Clock Prescalers
                                    Selection This parameter can be a value of
                                    @ref RCCEx_SAI1_BlockA_Clock_Source */

    uint32_t SaiBClockSelection; /*!< Specifies SAI1_B Clock Prescalers
                                    Selection This parameter can be a value of
                                    @ref RCCEx_SAI1_BlockB_Clock_Source */
#endif                           /* STM32F413xx || STM32F423xx */

    uint32_t PLLI2SSelection; /*!< Specifies PLL I2S Clock Source Selection.
                                   This parameter can be a value of @ref
                                 RCCEx_PLL_I2S_Clock_Source */
...
typedef struct {
    uint32_t
        PLLI2SN; /*!< Specifies the multiplication factor for PLLI2S VCO output
                    clock. This parameter must be a number between Min_Data = 50
                    and Max_Data = 432. This parameter will be used only when
...
typedef struct {
    uint32_t
        PLLSAIN; /*!< Specifies the multiplication factor for PLLI2S VCO output
                    clock. This parameter must be a number between Min_Data = 50
                    and Max_Data = 432. This parameter will be used only when
    ...
    uint32_t PLLSAIP; /*!< Specifies division factor for OTG FS and SDIO clocks.
                         ...
                         STM32F469xx/STM32F479xx devices. This parameter must be
                         a value of @ref RCCEx_PLLSAIP_Clock_Divider  */
#endif                /* STM32F469xx || STM32F479xx */

    uint32_t PLLSAIQ; /*!< Specifies the division factor for SAI1 clock.
                           This parameter must be a number between Min_Data = 2
                         and Max_Data = 15. This parameter will be used only
                         when PLLSAI is selected as Clock Source SAI or LTDC */
...
typedef struct {
    ...
    uint32_t PLLSAIDivR; /*!< Specifies the PLLSAI division factor for LTDC
                            clock. This parameter must be one value of @ref
                            RCCEx_PLLSAI_DIVR */
...
#if defined(STM32F469xx) || defined(STM32F479xx)
    uint32_t Clk48ClockSelection; /*!< Specifies CLK48 Clock Selection this
                                     clock used OTG FS, SDIO and RNG clocks.
                                       This parameter can be a value of @ref
                                     RCCEx_CLK48_Clock_Source */
...
typedef struct {
    ...
    uint32_t
        PLLI2SN; /*!< Specifies the multiplication factor for PLLI2S VCO output
                    clock. This parameter must be a number between Min_Data = 50
                    and Max_Data = 432 Except for STM32F411xE devices where the
                    Min_Data = 192. This parameter will be used only when PLLI2S
                    is selected as Clock Source I2S or SAI */
 ...
 */
          ...
          STM32F401xC || STM32F401xE || STM32F411xE || STM32F469xx ||          \
          STM32F479xx */
...
#endif /* STM32F446xx || STM32F412Zx || STM32F412Vx || STM32F412Rx ||          \
          STM32F412Cx */
/**
 * @}
 */
...
#endif /* STM32F405xx || STM32F415xx || STM32F407xx || STM32F417xx ||          \
          STM32F427xx || STM32F437xx || STM32F429xx || STM32F439xx ||          \
          STM32F401xC || STM32F401xE || STM32F411xE || STM32F446xx ||          \
...
#if defined(STM32F427xx) || defined(STM32F437xx) || defined(STM32F429xx) ||    \
    defined(STM32F439xx) || defined(STM32F469xx) || defined(STM32F479xx)
/** @defgroup RCCEx_AHB1_Clock_Enable_Disable AHB1 Peripheral Clock Enable
 * Disable
...
/** @defgroup RCCEx_AHB2_Clock_Enable_Disable AHB2 Peripheral Clock Enable
 * Disable
...
/** @defgroup RCCEx_AHB2_Peripheral_Clock_Enable_Disable_Status AHB2 Peripheral
 * Clock Enable Disable Status
 * @brief  Get the enable or disable status of the AHB1 peripheral clock.
 * @note   After reset, the peripheral clock (used for registers read/write
 * access) is disabled and the application software has to enable this clock
...
/** @defgroup RCCEx_AHB3_Clock_Enable_Disable AHB3 Peripheral Clock Enable
 * Disable
...
/** @defgroup RCCEx_AHB3_Peripheral_Clock_Enable_Disable_Status AHB3 Peripheral
 * Clock Enable Disable Status
...
/** @defgroup RCCEx_APB1_Clock_Enable_Disable APB1 Peripheral Clock Enable
 * Disable
...
/** @defgroup RCCEx_APB2_Clock_Enable_Disable APB2 Peripheral Clock Enable
 * Disable
...
/** @defgroup RCCEx_AHB1_LowPower_Enable_Disable AHB1 Peripheral Low Power
 * Enable Disable
...
/** @defgroup RCCEx_AHB2_LowPower_Enable_Disable AHB2 Peripheral Low Power
 * Enable Disable
...
/** @defgroup RCCEx_AHB3_LowPower_Enable_Disable AHB3 Peripheral Low Power
 * Enable Disable
...
/** @defgroup RCCEx_APB1_LowPower_Enable_Disable APB1 Peripheral Low Power
 * Enable Disable
...
/** @defgroup RCCEx_APB2_LowPower_Enable_Disable APB2 Peripheral Low Power
 * Enable Disable
...
#endif /* STM32F412Rx || STM32F412Vx || STM32F412Zx ||  STM32F413xx ||         \
          STM32F423xx */
...
/** @brief  Macro to configure the main PLL clock source, multiplication and
  ...
  *            @arg RCC_PLLSOURCE_HSI: HSI oscillator clock selected as PLL
  clock entry
  *            @arg RCC_PLLSOURCE_HSE: HSE oscillator clock selected as PLL
  clock entry
  * @note   This clock source (RCC_PLLSource) is common for the main PLL and
  PLLI2S.
  ...
  * @note   You have to set the PLLM parameter correctly to ensure that the VCO
  input
  *         frequency ranges from 1 to 2 MHz. It is recommended to select a
  frequency
  ...
  *
  * @param  __PLLP__ specifies the division factor for main system clock
  (SYSCLK)
  *         This parameter must be a number in the range {2, 4, 6, or 8}.
  *
  * @param  __PLLQ__ specifies the division factor for OTG FS, SDIO and RNG
  clocks
  *         This parameter must be a number between Min_Data = 2 and Max_Data
  = 15.
  * @note   If the USB OTG FS is used in your application, you have to set the
  *         PLLQ parameter correctly to have 48 MHz clock for the USB. However,
  *         the SDIO and RNG need a frequency lower than or equal to 48 MHz to
  work
  *         correctly.
  *
  ...
  *         This parameter must be a number between Min_Data = 2 and Max_Data
  = 7.
  * @note   This parameter is only available in
  STM32F446xx/STM32F469xx/STM32F479xx/
            STM32F412Zx/STM32F412Vx/STM32F412Rx/STM32F412Cx/STM32F413xx/STM32F423xx
  devices.
  *
 ...
 * @param  __RCC_PLLSource__ specifies the PLL entry clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_PLLSOURCE_HSI: HSI oscillator clock selected as PLL clock
 * entry
 *            @arg RCC_PLLSOURCE_HSE: HSE oscillator clock selected as PLL clock
 * entry
 * @note   This clock source (RCC_PLLSource) is common for the main PLL and
 * PLLI2S.
 * @param  __PLLM__ specifies the division factor for PLL VCO input clock
 ...
 *         This parameter must be a number between Min_Data = 50 and Max_Data =
 * 432 Except for STM32F411xE devices where Min_Data = 192.
 * @note   You have to set the PLLN parameter correctly to ensure that the VCO
 *         output frequency is between 100 and 432 MHz, Except for STM32F411xE
 * devices where frequency is between 192 and 432 MHz.
 * @param  __PLLP__ specifies the division factor for main system clock (SYSCLK)
 *         This parameter must be a number in the range {2, 4, 6, or 8}.
 *
 * @param  __PLLQ__ specifies the division factor for OTG FS, SDIO and RNG
 * clocks This parameter must be a number between Min_Data = 2 and Max_Data
 * = 15.
 * @note   If the USB OTG FS is used in your application, you have to set the
 *         PLLQ parameter correctly to have 48 MHz clock for the USB. However,
 *         the SDIO and RNG need a frequency lower than or equal to 48 MHz to
 ...
 * @note  The PLLI2S is disabled by hardware when entering STOP and STANDBY
 * modes.
 */
...
#if defined(STM32F446xx)
/** @brief  Macro to configure the PLLI2S clock multiplication and division
 * factors .
 ...
 *         This parameter must be a number between Min_Data = 2 and Max_Data
 * = 63.
 * @note   You have to set the PLLI2SM parameter correctly to ensure that the
 * VCO input frequency ranges from 1 to 2 MHz. It is recommended to select a
 * frequency of 1 MHz to limit PLLI2S jitter.
 *
 * @param  __PLLI2SN__ specifies the multiplication factor for PLLI2S VCO output
 * clock This parameter must be a number between Min_Data = 50 and Max_Data =
 * 432.
 * @note   You have to set the PLLI2SN parameter correctly to ensure that the
 * VCO output frequency is between Min_Data = 100 and Max_Data = 432 MHz.
 *
 ...
 *         This parameter must be a number between Min_Data = 2 and Max_Data
 * = 63.
 * @note   The PLLI2SM parameter is only used with STM32F411xE/STM32F410xx
 * Devices
 * @note   You have to set the PLLI2SM parameter correctly to ensure that the
 * VCO input frequency ranges from 1 to 2 MHz. It is recommended to select a
 * frequency of 2 MHz to limit PLLI2S jitter.
 * @param  __PLLI2SN__ specifies the multiplication factor for PLLI2S VCO output
 * clock This parameter must be a number between Min_Data = 192 and Max_Data =
 * 432.
 * @note   You have to set the PLLI2SN parameter correctly to ensure that the
 * VCO output frequency is between Min_Data = 192 and Max_Data = 432 MHz.
 * @param  __PLLI2SR__ specifies the division factor for I2S clock
 *         This parameter must be a number between Min_Data = 2 and Max_Data
 * = 7.
 * @note   You have to set the PLLI2SR parameter correctly to not exceed 192 MHz
...
#if defined(STM32F427xx) || defined(STM32F437xx) || defined(STM32F429xx) ||    \
    defined(STM32F439xx) || defined(STM32F469xx) || defined(STM32F479xx)
/** @brief  Macro used by the SAI HAL driver to configure the PLLI2S clock
 ...
 *         This parameter must be a number between Min_Data = 2 and Max_Data
 * = 15.
 * @note   the PLLI2SQ parameter is only available with
 * STM32F427xx/437xx/429xx/439xx/469xx/479xx Devices and can be configured using
 * the __HAL_RCC_PLLI2S_PLLSAICLK_CONFIG() macro
 * @param  __PLLI2SR__ specifies the division factor for I2S clock
 *         This parameter must be a number between Min_Data = 2 and Max_Data
 * = 7.
 * @note   You have to set the PLLI2SR parameter correctly to not exceed 192 MHz
 ...
 * @note  The PLLSAI is disabled by hardware when entering STOP and STANDBY
 * modes.
 */
...
#if defined(STM32F446xx)
/** @brief  Macro to configure the PLLSAI clock multiplication and division
 * factors.
 *
 * @param  __PLLSAIM__ specifies the division factor for PLLSAI VCO input clock
 *         This parameter must be a number between Min_Data = 2 and Max_Data
 * = 63.
 * @note   You have to set the PLLSAIM parameter correctly to ensure that the
 * VCO input frequency ranges from 1 to 2 MHz. It is recommended to select a
 * frequency of 1 MHz to limit PLLI2S jitter.
 * @note   The PLLSAIM parameter is only used with STM32F446xx Devices
 *
 * @param  __PLLSAIN__ specifies the multiplication factor for PLLSAI VCO output
 * clock. This parameter must be a number between Min_Data = 50 and Max_Data =
 * 432.
 * @note   You have to set the PLLSAIN parameter correctly to ensure that the
 * VCO output frequency is between Min_Data = 100 and Max_Data = 432 MHz.
 *
 * @param  __PLLSAIP__ specifies division factor for OTG FS, SDIO and RNG
 * clocks. This parameter must be a number in the range {2, 4, 6, or 8}.
 ...
 *         This parameter must be a number between Min_Data = 2 and Max_Data
 * = 7.
 * @note   the PLLI2SR parameter is only available with STM32F427/437/429/439xx
 * Devices
 */
 ...
 * = 32. SAI1 clock frequency = f(PLLSAIQ) / __PLLSAIDivQ__
 */
 ...
 *
 * @note   The LTDC peripheral is only available with
 * STM32F427/437/429/439/469/479xx Devices.
 * @note   This function must be called before enabling the PLLSAI.
 * @param  __PLLSAIDivR__ specifies the PLLSAI division factor for LTDC clock .
 *          This parameter must be a number between Min_Data = 2 and Max_Data
 * = 16. LTDC clock frequency = f(PLLSAIR) / __PLLSAIDivR__
 */
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_I2SCLKSOURCE_PLLI2S: PLLI2S clock used as I2S clock
 * source.
 *            @arg RCC_I2SCLKSOURCE_EXT: External clock mapped on the I2S_CKIN
 ...
 *            @arg @ref RCC_I2SCLKSOURCE_PLLI2S: PLLI2S clock used as I2S clock
 * source.
 *            @arg @ref RCC_I2SCLKSOURCE_EXT External clock mapped on the
 * I2S_CKIN pin used as I2S clock source
 */
 ...
 * @note   The SAI peripheral is only available with
 * STM32F427/437/429/439/469/479xx Devices.
 * @note   This function must be called before enabling PLLSAI, PLLI2S and
 *         the SAI clock.
 * @param  __SOURCE__ specifies the SAI Block A clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_SAIACLKSOURCE_PLLI2S: PLLI2S_Q clock divided by
 * PLLI2SDIVQ used as SAI1 Block A clock.
 *            @arg RCC_SAIACLKSOURCE_PLLSAI: PLLISAI_Q clock divided by
 * PLLSAIDIVQ used as SAI1 Block A clock.
 *            @arg RCC_SAIACLKSOURCE_Ext: External clock mapped on the I2S_CKIN
 * pin used as SAI1 Block A clock.
 */
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_SAIBCLKSOURCE_PLLI2S: PLLI2S_Q clock divided by
 * PLLI2SDIVQ used as SAI1 Block B clock.
 *            @arg RCC_SAIBCLKSOURCE_PLLSAI: PLLISAI_Q clock divided by
 * PLLSAIDIVQ used as SAI1 Block B clock.
 *            @arg RCC_SAIBCLKSOURCE_Ext: External clock mapped on the I2S_CKIN
 * pin used as SAI1 Block B clock.
 */
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_SAI1CLKSOURCE_PLLI2S: PLLI2S_Q clock divided by
 * PLLI2SDIVQ used as SAI1 clock.
 *            @arg RCC_SAI1CLKSOURCE_PLLSAI: PLLISAI_Q clock divided by
 * PLLSAIDIVQ used as SAI1 clock.
 *            @arg RCC_SAI1CLKSOURCE_PLLR: PLL VCO Output divided by PLLR used
 * as SAI1 clock.
 *            @arg RCC_SAI1CLKSOURCE_EXT: External clock mapped on the I2S_CKIN
 * pin used as SAI1 clock.
 */
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_SAI2CLKSOURCE_PLLI2S: PLLI2S_Q clock divided by
 * PLLI2SDIVQ used as SAI2 clock.
 *            @arg RCC_SAI2CLKSOURCE_PLLSAI: PLLISAI_Q clock divided by
 * PLLSAIDIVQ used as SAI2 clock.
 *            @arg RCC_SAI2CLKSOURCE_PLLR: PLL VCO Output divided by PLLR used
 * as SAI2 clock.
 *            @arg RCC_SAI2CLKSOURCE_PLLSRC: HSI or HSE depending from PLL
 * Source clock used as SAI2 clock.
 */
 ...
 * @note   This function must be called before enabling PLL, PLLI2S and the I2S
 * clock.
 * @param  __SOURCE__ specifies the I2S APB1 clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_I2SAPB1CLKSOURCE_PLLI2S: PLLI2S VCO output clock divided
 * by PLLI2SR used as I2S clock.
 *            @arg RCC_I2SAPB1CLKSOURCE_EXT: External clock mapped on the
 * I2S_CKIN pin used as I2S APB1 clock.
 *            @arg RCC_I2SAPB1CLKSOURCE_PLLR: PLL VCO Output divided by PLLR
 * used as I2S APB1 clock.
 *            @arg RCC_I2SAPB1CLKSOURCE_PLLSRC: HSI or HSE depending from PLL
 * source Clock.
 */
 ...
 * @param  __SOURCE__ specifies the SAI Block A clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_I2SAPB2CLKSOURCE_PLLI2S: PLLI2S VCO output clock divided
 * by PLLI2SR used as I2S clock.
 *            @arg RCC_I2SAPB2CLKSOURCE_EXT: External clock mapped on the
 * I2S_CKIN pin used as I2S APB2 clock.
 *            @arg RCC_I2SAPB2CLKSOURCE_PLLR: PLL VCO Output divided by PLLR
 * used as I2S APB2 clock.
 *            @arg RCC_I2SAPB2CLKSOURCE_PLLSRC: HSI or HSE depending from PLL
 * source Clock.
 */
 ...
 *            @arg RCC_FMPI2C1CLKSOURCE_SYSCLK: SYS clock selected as FMPI2C1
 * clock
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_CLK48CLKSOURCE_PLLQ: PLL VCO Output divided by PLLQ used
 * as CLK48 clock.
 *            @arg RCC_CLK48CLKSOURCE_PLLSAIP: PLLSAI VCO Output divided by
 ...
 *            @arg RCC_SDIOCLKSOURCE_SYSCLK: System clock output used as SDIO
 * clock.
 */
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_SPDIFRXCLKSOURCE_PLLR: PLL VCO Output divided by PLLR
 * used as SPDIFRX clock.
 *            @arg RCC_SPDIFRXCLKSOURCE_PLLI2SP: PLLI2S VCO Output divided by
 * PLLI2SP used as SPDIFRX clock.
 */
 ...
 *            @arg RCC_DFSDM1CLKSOURCE_SYSCLK: System clock used as kernel
 * clock.
 * @retval None
 */
...
/** @brief  Macro to configure DFSDM1 Audio clock source selection.
  ...
  *         This parameter can be one of the following values:
  *            @arg RCC_DFSDM1AUDIOCLKSOURCE_I2S1: CK_I2S_PCLK1 selected as
  audio clock
  *            @arg RCC_DFSDM1AUDIOCLKSOURCE_I2S2: CK_I2S_PCLK2 selected as
  audio clock
  */
 ...
 *            @arg RCC_DFSDM2CLKSOURCE_SYSCLK: System clock used as kernel
 * clock.
 * @retval None
 */
...
/** @brief  Macro to configure DFSDM1 Audio clock source selection.
 * @note   This configuration is only available with STM32F413xx/STM32F423xx
 * Devices.
 * @param  __SOURCE__ specifies the DFSDM2 Audio clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_DFSDM2AUDIOCLKSOURCE_I2S1: CK_I2S_PCLK1 selected as audio
 * clock
 *            @arg RCC_DFSDM2AUDIOCLKSOURCE_I2S2: CK_I2S_PCLK2 selected as audio
 * clock
 */
...
/** @brief  Macro to configure SAI1BlockA clock source selection.
 * @note   The SAI peripheral is only available with STM32F413xx/STM32F423xx
 * Devices.
 * @note   This function must be called before enabling PLLSAI, PLLI2S and
 *         the SAI clock.
 * @param  __SOURCE__ specifies the SAI Block A clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_SAIACLKSOURCE_PLLI2SR: PLLI2S_R clock divided (R2) used
 * as SAI1 Block A clock.
 *            @arg RCC_SAIACLKSOURCE_EXT: External clock mapped on the I2S_CKIN
 * pinused as SAI1 Block A clock.
 *            @arg RCC_SAIACLKSOURCE_PLLR: PLL_R clock divided (R1) used as SAI1
 * Block A clock.
 *            @arg RCC_SAIACLKSOURCE_PLLSRC: HSI or HSE depending from PLL
 * source Clock.
 */
#define __HAL_RCC_SAI_BLOCKACLKSOURCE_CONFIG(__SOURCE__)                       \
    (MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_SAI1ASRC, (__SOURCE__)))
 ...
 * @param  __SOURCE__ specifies the SAI Block B clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_SAIBCLKSOURCE_PLLI2SR: PLLI2S_R clock divided (R2) used
 * as SAI1 Block A clock.
 *            @arg RCC_SAIBCLKSOURCE_EXT: External clock mapped on the I2S_CKIN
 * pin used as SAI1 Block A clock.
 *            @arg RCC_SAIBCLKSOURCE_PLLR: PLL_R clock divided (R1) used as SAI1
 * Block A clock.
 *            @arg RCC_SAIBCLKSOURCE_PLLSRC: HSI or HSE depending from PLL
 * source Clock.
 */
#define __HAL_RCC_SAI_BLOCKBCLKSOURCE_CONFIG(__SOURCE__)                       \
    (MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_SAI1BSRC, (__SOURCE__)))
 ...
 * @param  __SOURCE__ specifies the I2S clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_PLLI2SCLKSOURCE_PLLSRC: HSI or HSE depending from PLL
 * source Clock.
 *            @arg RCC_PLLI2SCLKSOURCE_EXT: External clock mapped on the
 * I2S_CKIN pin used as I2S clock source.
 */
 ...
 *            @arg RCC_CLK48CLKSOURCE_PLLQ: PLL VCO Output divided by PLLQ used
 * as CLK48 clock.
 *            @arg RCC_CLK48CLKSOURCE_PLLI2SQ: PLLI2S VCO Output divided by
 * PLLI2SQ used as CLK48 clock.
 */
#define __HAL_RCC_CLK48_CONFIG(__SOURCE__)                                     \
    (MODIFY_REG(RCC->DCKCFGR2, RCC_DCKCFGR2_CK48MSEL, (uint32_t)(__SOURCE__)))
 ...
 * @param  __SOURCE__ specifies the I2S clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_I2SAPBCLKSOURCE_PLLR: PLL VCO output clock divided by
 * PLLR.
 *            @arg RCC_I2SAPBCLKSOURCE_EXT: External clock mapped on the
 * I2S_CKIN pin.
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_TIMPRES_DESACTIVATED: The Timers kernels clocks prescaler
 * is equal to HPRE if PPREx is corresponding to division by 1 or 2, else it is
 * equal to [(HPRE * PPREx) / 2] if PPREx is corresponding to division by 4 or
 * more.
 *            @arg RCC_TIMPRES_ACTIVATED: The Timers kernels clocks prescaler is
 *                 equal to HPRE if PPREx is corresponding to division by 1, 2
 * or 4, else it is equal to [(HPRE * PPREx) / 4] if PPREx is corresponding to
 * division by 8 or more.
 */
...
#define __HAL_RCC_MCO1_DISABLE()                                               \
    (*(__IO uint32_t *)RCC_CFGR_MCO1EN_BB = DISABLE)
...
#define __HAL_RCC_MCO2_DISABLE()                                               \
    (*(__IO uint32_t *)RCC_CFGR_MCO2EN_BB = DISABLE)
 ...
 * @{
 */
/** @defgroup RCCEx_IS_RCC_Definitions RCC Private macros to check input
 * parameters
 * @{
 */
...
#endif /* STM32F411xE || STM32F446xx || STM32F412Zx || STM32F412Vx ||          \
          STM32F412Rx || STM32F412Cx || STM32F413xx || STM32F423xx  */
