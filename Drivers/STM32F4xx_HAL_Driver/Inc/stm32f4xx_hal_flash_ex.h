...
typedef struct {
    ...
    uint32_t WRPSector; /*!< Specifies the sector(s) to be write protected.
                        The value of this parameter depend on device used within
                        the same series */
    ...
    uint8_t USERConfig; /*!< Program the FLASH User Option Byte: IWDG_SW /
                           RST_STOP / RST_STDBY. */
...
typedef struct {
    ...
    uint32_t Banks; /*!< Select banks for PCROP activation/deactivation of all
                       sectors. This parameter must be a value of @ref
                       FLASHEx_Banks */
...
#define FLASH_TYPEERASE_MASSERASE                                              \
    0x00000001U /*!< Flash Mass erase activation */
/**
 * @}
 */
...
#define OB_WRPSTATE_DISABLE                                                    \
    0x00000000U /*!< Disable the write protection of the desired bank 1        \
                   sectors */
...
/** @defgroup FLASHEx_Option_Bytes_Read_Protection FLASH Option Bytes Read
 * Protection
 * @{
 */
...
#define OB_STOP_NO_RST                                                         \
    ((uint8_t)0x40) /*!< No reset generated when entering in STOP */
#define OB_STOP_RST                                                            \
    ((uint8_t)0x00) /*!< Reset generated when entering in STOP    */
/**
 * @}
 */
...
#define OB_STDBY_NO_RST                                                        \
    ((uint8_t)0x80) /*!< No reset generated when entering in STANDBY */
#define OB_STDBY_RST                                                           \
    ((uint8_t)0x00) /*!< Reset generated when entering in STANDBY    */
/**
 * @}
 */
...
#define OB_BOR_LEVEL3                                                          \
    ((uint8_t)0x00) /*!< Supply voltage ranges from 2.70 to 3.60 V */
#define OB_BOR_LEVEL2                                                          \
    ((uint8_t)0x04) /*!< Supply voltage ranges from 2.40 to 2.70 V */
#define OB_BOR_LEVEL1                                                          \
    ((uint8_t)0x08) /*!< Supply voltage ranges from 2.10 to 2.40 V */
#define OB_BOR_OFF                                                             \
    ((uint8_t)0x0C) /*!< Supply voltage ranges from 1.62 to 2.10 V */
/**
 * @}
 */
...
#define OPTIONBYTE_PCROP                                                       \
    0x00000001U /*!< PCROP option byte configuration      */
#define OPTIONBYTE_BOOTCONFIG                                                  \
    0x00000002U /*!< BOOTConfig option byte configuration */
#endif          /* STM32F427xx || STM32F437xx || STM32F429xx || STM32F439xx || \
                   STM32F469xx || STM32F479xx */
...
#define FLASH_LATENCY_0                                                        \
    FLASH_ACR_LATENCY_0WS /*!< FLASH Zero Latency cycle      */
#define FLASH_LATENCY_1                                                        \
    FLASH_ACR_LATENCY_1WS /*!< FLASH One Latency cycle       */
#define FLASH_LATENCY_2                                                        \
    FLASH_ACR_LATENCY_2WS /*!< FLASH Two Latency cycles      */
#define FLASH_LATENCY_3                                                        \
    FLASH_ACR_LATENCY_3WS /*!< FLASH Three Latency cycles    */
#define FLASH_LATENCY_4                                                        \
    FLASH_ACR_LATENCY_4WS /*!< FLASH Four Latency cycles     */
#define FLASH_LATENCY_5                                                        \
    FLASH_ACR_LATENCY_5WS /*!< FLASH Five Latency cycles     */
#define FLASH_LATENCY_6                                                        \
    FLASH_ACR_LATENCY_6WS /*!< FLASH Six Latency cycles      */
#define FLASH_LATENCY_7                                                        \
    FLASH_ACR_LATENCY_7WS /*!< FLASH Seven Latency cycles    */
#define FLASH_LATENCY_8                                                        \
    FLASH_ACR_LATENCY_8WS /*!< FLASH Eight Latency cycles    */
#define FLASH_LATENCY_9                                                        \
    FLASH_ACR_LATENCY_9WS /*!< FLASH Nine Latency cycles     */
#define FLASH_LATENCY_10                                                       \
    FLASH_ACR_LATENCY_10WS /*!< FLASH Ten Latency cycles      */
#define FLASH_LATENCY_11                                                       \
    FLASH_ACR_LATENCY_11WS /*!< FLASH Eleven Latency cycles   */
#define FLASH_LATENCY_12                                                       \
    FLASH_ACR_LATENCY_12WS /*!< FLASH Twelve Latency cycles   */
#define FLASH_LATENCY_13                                                       \
    FLASH_ACR_LATENCY_13WS /*!< FLASH Thirteen Latency cycles */
#define FLASH_LATENCY_14                                                       \
    FLASH_ACR_LATENCY_14WS /*!< FLASH Fourteen Latency cycles */
#define FLASH_LATENCY_15                                                       \
    FLASH_ACR_LATENCY_15WS /*!< FLASH Fifteen Latency cycles  */
#endif /* STM32F427xx || STM32F437xx || STM32F429xx|| STM32F439xx ||           \
...
#define FLASH_LATENCY_7                                                        \
    FLASH_ACR_LATENCY_7WS /*!< FLASH Seven Latency cycles    */
#endif /* STM32F40xxx || STM32F41xxx || STM32F401xx || STM32F410xx ||          \
          STM32F411xE || STM32F412Zx || STM32F412Vx || STM32F412Rx ||          \
          STM32F412Cx || STM32F413xx || STM32F423xx */
/*--------------------------------------------------------------------------------------------------------------*/
...
#define FLASH_BANK_1 1U /*!< Bank 1   */
#endif /* STM32F40xxx || STM32F41xxx || STM32F401xx || STM32F410xx ||          \
          STM32F411xE || STM32F446xx || STM32F412Zx || STM32F412Vx ||          \
...
#define FLASH_MER_BIT                                                          \
    (FLASH_CR_MER1 | FLASH_CR_MER2) /*!< 2 MER bits here to clear */
#endif /* STM32F427xx || STM32F437xx || STM32F429xx|| STM32F439xx ||           \
          STM32F469xx || STM32F479xx */
...
/** @defgroup FLASHEx_Option_Bytes_Write_Protection FLASH Option Bytes Write
 * Protection
 * @{
 */
...
#define OB_WRP_SECTOR_12                                                       \
    0x00000001U << 12U /*!< Write protection of Sector12    */
#define OB_WRP_SECTOR_13                                                       \
    0x00000002U << 12U /*!< Write protection of Sector13    */
#define OB_WRP_SECTOR_14                                                       \
    0x00000004U << 12U /*!< Write protection of Sector14    */
#define OB_WRP_SECTOR_15                                                       \
    0x00000008U << 12U /*!< Write protection of Sector15    */
#define OB_WRP_SECTOR_16                                                       \
    0x00000010U << 12U /*!< Write protection of Sector16    */
#define OB_WRP_SECTOR_17                                                       \
    0x00000020U << 12U /*!< Write protection of Sector17    */
#define OB_WRP_SECTOR_18                                                       \
    0x00000040U << 12U /*!< Write protection of Sector18    */
#define OB_WRP_SECTOR_19                                                       \
    0x00000080U << 12U /*!< Write protection of Sector19    */
#define OB_WRP_SECTOR_20                                                       \
    0x00000100U << 12U /*!< Write protection of Sector20    */
#define OB_WRP_SECTOR_21                                                       \
    0x00000200U << 12U /*!< Write protection of Sector21    */
#define OB_WRP_SECTOR_22                                                       \
    0x00000400U << 12U /*!< Write protection of Sector22    */
#define OB_WRP_SECTOR_23                                                       \
    0x00000800U << 12U /*!< Write protection of Sector23    */
#define OB_WRP_SECTOR_All                                                      \
    0x00000FFFU << 12U /*!< Write protection of all Sectors */
#endif /* STM32F427xx || STM32F437xx || STM32F429xx|| STM32F439xx ||           \
          STM32F469xx || STM32F479xx */
/*-----------------------------------------------------------------------------------------------------*/
...
/** @defgroup FLASHEx_Option_Bytes_PC_ReadWrite_Protection FLASH Option Bytes PC
...
#if defined(STM32F427xx) || defined(STM32F437xx) || defined(STM32F429xx) ||    \
    defined(STM32F439xx) || defined(STM32F469xx) || defined(STM32F479xx)
#define OB_PCROP_SECTOR_0                                                      \
    0x00000001U /*!< PC Read/Write protection of Sector0      */
#define OB_PCROP_SECTOR_1                                                      \
    0x00000002U /*!< PC Read/Write protection of Sector1      */
#define OB_PCROP_SECTOR_2                                                      \
    0x00000004U /*!< PC Read/Write protection of Sector2      */
#define OB_PCROP_SECTOR_3                                                      \
    0x00000008U /*!< PC Read/Write protection of Sector3      */
#define OB_PCROP_SECTOR_4                                                      \
    0x00000010U /*!< PC Read/Write protection of Sector4      */
#define OB_PCROP_SECTOR_5                                                      \
    0x00000020U /*!< PC Read/Write protection of Sector5      */
#define OB_PCROP_SECTOR_6                                                      \
    0x00000040U /*!< PC Read/Write protection of Sector6      */
#define OB_PCROP_SECTOR_7                                                      \
    0x00000080U /*!< PC Read/Write protection of Sector7      */
#define OB_PCROP_SECTOR_8                                                      \
    0x00000100U /*!< PC Read/Write protection of Sector8      */
#define OB_PCROP_SECTOR_9                                                      \
    0x00000200U /*!< PC Read/Write protection of Sector9      */
#define OB_PCROP_SECTOR_10                                                     \
    0x00000400U /*!< PC Read/Write protection of Sector10     */
#define OB_PCROP_SECTOR_11                                                     \
    0x00000800U /*!< PC Read/Write protection of Sector11     */
#define OB_PCROP_SECTOR_12                                                     \
    0x00000001U /*!< PC Read/Write protection of Sector12     */
#define OB_PCROP_SECTOR_13                                                     \
    0x00000002U /*!< PC Read/Write protection of Sector13     */
#define OB_PCROP_SECTOR_14                                                     \
    0x00000004U /*!< PC Read/Write protection of Sector14     */
#define OB_PCROP_SECTOR_15                                                     \
    0x00000008U /*!< PC Read/Write protection of Sector15     */
#define OB_PCROP_SECTOR_16                                                     \
    0x00000010U /*!< PC Read/Write protection of Sector16     */
#define OB_PCROP_SECTOR_17                                                     \
    0x00000020U /*!< PC Read/Write protection of Sector17     */
#define OB_PCROP_SECTOR_18                                                     \
    0x00000040U /*!< PC Read/Write protection of Sector18     */
#define OB_PCROP_SECTOR_19                                                     \
    0x00000080U /*!< PC Read/Write protection of Sector19     */
#define OB_PCROP_SECTOR_20                                                     \
    0x00000100U /*!< PC Read/Write protection of Sector20     */
#define OB_PCROP_SECTOR_21                                                     \
    0x00000200U /*!< PC Read/Write protection of Sector21     */
#define OB_PCROP_SECTOR_22                                                     \
    0x00000400U /*!< PC Read/Write protection of Sector22     */
#define OB_PCROP_SECTOR_23                                                     \
    0x00000800U /*!< PC Read/Write protection of Sector23     */
#define OB_PCROP_SECTOR_All                                                    \
    0x00000FFFU /*!< PC Read/Write protection of all Sectors  */
#endif          /* STM32F427xx || STM32F437xx || STM32F429xx|| STM32F439xx ||  \
                   STM32F469xx || STM32F479xx */
/*-----------------------------------------------------------------------------------------------------*/
...
#define OB_PCROP_SECTOR_11                                                     \
    0x00000800U /*!< PC Read/Write protection of Sector11     */
#define OB_PCROP_SECTOR_12                                                     \
    0x00001000U /*!< PC Read/Write protection of Sector12     */
#define OB_PCROP_SECTOR_13                                                     \
    0x00002000U /*!< PC Read/Write protection of Sector13     */
#define OB_PCROP_SECTOR_14                                                     \
    0x00004000U /*!< PC Read/Write protection of Sector14     */
#define OB_PCROP_SECTOR_15                                                     \
    0x00004000U /*!< PC Read/Write protection of Sector15     */
#define OB_PCROP_SECTOR_All                                                    \
    0x00007FFFU /*!< PC Read/Write protection of all Sectors  */
#endif          /* STM32F413xx || STM32F423xx */
/*-----------------------------------------------------------------------------------------------------*/
...
#define OB_PCROP_DESELECTED                                                    \
    ((uint8_t)0x00) /*!< Disabled PcROP, nWPRi bits used for Write Protection  \
                       on sector i */
...
void HAL_FLASHEx_OBGetConfig(FLASH_OBProgramInitTypeDef *pOBInit);
    ...
    defined(STM32F423xx)
HAL_StatusTypeDef
HAL_FLASHEx_AdvOBProgram(FLASH_AdvOBProgramInitTypeDef *pAdvOBInit);
...
/** @defgroup FLASHEx_IS_FLASH_Definitions FLASH Private macros to check input
 * parameters
 * @{
 */
...
#define IS_OBEX(VALUE)                                                         \
    (((VALUE) == OPTIONBYTE_PCROP) || ((VALUE) == OPTIONBYTE_BOOTCONFIG))
#endif /* STM32F427xx || STM32F437xx || STM32F429xx || STM32F439xx ||          \
          STM32F469xx || STM32F479xx */
...
#if defined(STM32F427xx) || defined(STM32F437xx) || defined(STM32F429xx) ||    \
    defined(STM32F439xx) || defined(STM32F469xx) || defined(STM32F479xx)
#define IS_OB_BOOT(BOOT)                                                       \
    (((BOOT) == OB_DUAL_BOOT_ENABLE) || ((BOOT) == OB_DUAL_BOOT_DISABLE))
#endif /* STM32F427xx || STM32F437xx || STM32F429xx || STM32F439xx ||          \
          STM32F469xx || STM32F479xx */
