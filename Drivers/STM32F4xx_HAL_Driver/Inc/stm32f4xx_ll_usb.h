...
typedef struct {
    ...
    uint8_t use_dedicated_ep1; /*!< Enable or disable the use of the dedicated
                                  EP1 interrupt.              */

    uint8_t use_external_vbus; /*!< Enable or disable the use of the external
                                  VBUS.                        */
...
typedef struct {
    ...
    uint8_t
        ep_ss_schedule; /*!< Enable periodic endpoint start split schedule . */
...
/** @defgroup USB_LL_HPRT0_PRTSPD_SPEED_Defines USB Low Layer HPRT0 PRTSPD Speed
 * Defines
 * @{
 */
