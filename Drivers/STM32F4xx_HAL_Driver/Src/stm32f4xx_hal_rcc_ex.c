...
HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_I2S_APB1) ==
        ...
        if (PeriphClkInit->I2sApb1ClockSelection ==
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_I2S_APB2) ==
        ...
        /* Enable the PLLI2S when it's used as clock source for I2S */
        if (PeriphClkInit->I2sApb2ClockSelection ==
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_RTC) ==
        ...
        if ((tmpreg1 != 0x00000000U) &&
             ...
             * Domain */
            tmpreg1 = (RCC->BDCR & ~(RCC_BDCR_RTCSEL));
            /* RTC Clock selection can be changed only if the Backup Domain is
             * reset */
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SPDIFRX) ==
        ...
        if (PeriphClkInit->SpdifClockSelection ==
     ...
     * ------------------------*/
    /* PLLI2S is configured when a peripheral will use it as source clock :
       SAI1, SAI2, I2S on APB1, I2S on APB2 or SPDIFRX */
    if ((plli2sused == 1U) ||
        ...
        if (((((PeriphClkInit->PeriphClockSelection) &
               RCC_PERIPHCLK_I2S_APB1) == RCC_PERIPHCLK_I2S_APB1) &&
            ...
            /* Read PLLI2SP/PLLI2SQ value from PLLI2SCFGR register (this value
             * is not needed for I2S configuration) */
            ...
            /* PLLI2S_VCO = f(VCO clock) = f(PLLI2S clock input) *
             * (PLLI2SN/PLLI2SM) */
        ...
        if (((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI1) ==
            ...
            /* Read PLLI2SP/PLLI2SR value from PLLI2SCFGR register (this value
             * is not needed for SAI configuration) */
            plli2sp = ((((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SP) >>
                         RCC_PLLI2SCFGR_PLLI2SP_Pos) +
                        1U)
                       << 1U);
        ...
        if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SPDIFRX) ==
            ...
            /* Read PLLI2SR value from PLLI2SCFGR register (this value is not
             * need for SAI configuration) */
            ...
            __HAL_RCC_PLLI2S_CONFIG(
                PeriphClkInit->PLLI2S.PLLI2SM, PeriphClkInit->PLLI2S.PLLI2SN,
     ...
     * -----------------------*/
    /* PLLSAI is configured when a peripheral will use it as source clock :
     * SAI1, SAI2, CLK48 or SDIO */
    if (pllsaiused == 1U) {
        ...
        if (((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI1) ==
            ...
            /* Read PLLSAIP value from PLLSAICFGR register (this value is not
        ...
        if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_CLK48) ==
            ...
            /* Read PLLSAIQ value from PLLI2SCFGR register (this value is not
             * need for SAI configuration) */
            pllsaiq = ((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIQ) >>
                       RCC_PLLSAICFGR_PLLSAIQ_Pos);
            /* Configure the PLLSAI division factors */
            /* PLLSAI_VCO = f(VCO clock) = f(PLLSAI clock input) *
             * (PLLI2SN/PLLSAIM) */
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
     ...
     * parameter------------*/
    PeriphClkInit->PeriphClockSelection =
        RCC_PERIPHCLK_I2S_APB1 | RCC_PERIPHCLK_I2S_APB2 | RCC_PERIPHCLK_SAI1 |
    ...
    PeriphClkInit->PLLI2S.PLLI2SN =
        (uint32_t)((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SN) >>
    ...
    PeriphClkInit->PLLI2S.PLLI2SQ =
        (uint32_t)((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SQ) >>
                   RCC_PLLI2SCFGR_PLLI2SQ_Pos);
    PeriphClkInit->PLLI2S.PLLI2SR =
        (uint32_t)((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SR) >>
                   RCC_PLLI2SCFGR_PLLI2SR_Pos);
    /* Get the PLLSAI Clock configuration
     * --------------------------------------*/
    PeriphClkInit->PLLSAI.PLLSAIM =
        (uint32_t)((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIM) >>
                   RCC_PLLSAICFGR_PLLSAIM_Pos);
    PeriphClkInit->PLLSAI.PLLSAIN =
        (uint32_t)((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIN) >>
    ...
    PeriphClkInit->PLLSAI.PLLSAIQ =
        (uint32_t)((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIQ) >>
                   RCC_PLLSAICFGR_PLLSAIQ_Pos);
    /* Get the PLLSAI/PLLI2S division factors
     * ----------------------------------*/
    PeriphClkInit->PLLI2SDivQ =
        (uint32_t)((RCC->DCKCFGR & RCC_DCKCFGR_PLLI2SDIVQ) >>
                   RCC_DCKCFGR_PLLI2SDIVQ_Pos);
    PeriphClkInit->PLLSAIDivQ =
        (uint32_t)((RCC->DCKCFGR & RCC_DCKCFGR_PLLSAIDIVQ) >>
    ...
    PeriphClkInit->RTCClockSelection =
        (uint32_t)((tempreg) | (RCC->BDCR & RCC_BDCR_RTCSEL));
    ...
    case RCC_PERIPHCLK_SAI2: {
        ...
        case 0U: /* PLLSAI is the clock source for SAI*/
        {
            ...
            if ((RCC->PLLCFGR & RCC_PLLCFGR_PLLSRC) == RCC_PLLSOURCE_HSI) {
                ...
                vcoinput = (HSI_VALUE / (uint32_t)(RCC->PLLSAICFGR &
                                                   RCC_PLLSAICFGR_PLLSAIM));
            } else {
                /* In Case the PLL Source is HSE (External Clock) */
                vcoinput = ((HSE_VALUE / (uint32_t)(RCC->PLLSAICFGR &
                                                    RCC_PLLSAICFGR_PLLSAIM)));
            }
            /* PLLSAI_VCO Output = PLLSAI_VCO Input * PLLSAIN */
            /* SAI_CLK(first level) = PLLSAI_VCO Output/PLLSAIQ */
        ...
        case RCC_DCKCFGR_SAI2SRC_0: /* PLLI2S is the clock source for SAI*/
        {
            ...
            if ((RCC->PLLCFGR & RCC_PLLCFGR_PLLSRC) == RCC_PLLSOURCE_HSI) {
                /* In Case the PLL Source is HSI (Internal Clock) */
                vcoinput = (HSI_VALUE / (uint32_t)(RCC->PLLI2SCFGR &
                                                   RCC_PLLI2SCFGR_PLLI2SM));
            } else {
                /* In Case the PLL Source is HSE (External Clock) */
                vcoinput = ((HSE_VALUE / (uint32_t)(RCC->PLLI2SCFGR &
                                                    RCC_PLLI2SCFGR_PLLI2SM)));
            }
        ...
        case RCC_DCKCFGR_SAI1SRC: /* External clock is the clock source for
                                     SAI*/
        {
            frequency = EXTERNAL_CLOCK_VALUE;
            break;
        }
        case RCC_DCKCFGR_SAI2SRC: /* PLLSRC(HSE or HSI) is the clock source for
                                     SAI*/
        {
            if ((RCC->PLLCFGR & RCC_PLLCFGR_PLLSRC) == RCC_PLLSOURCE_HSI) {
                /* In Case the PLL Source is HSI (Internal Clock) */
    ...
    case RCC_PERIPHCLK_I2S_APB1: {
        ...
        case RCC_I2SAPB1CLKSOURCE_PLLI2S: {
            ...
            if ((RCC->PLLCFGR & RCC_PLLCFGR_PLLSRC) == RCC_PLLSOURCE_HSE) {
                ...
                vcoinput =
                    (uint32_t)(HSE_VALUE / (uint32_t)(RCC->PLLI2SCFGR &
                                                      RCC_PLLI2SCFGR_PLLI2SM));
            } else {
                /* Get the I2S source clock value */
                vcoinput =
                    (uint32_t)(HSI_VALUE / (uint32_t)(RCC->PLLI2SCFGR &
                                                      RCC_PLLI2SCFGR_PLLI2SM));
            }
        ...
        case RCC_I2SAPB1CLKSOURCE_PLLR: {
            ...
            if ((RCC->PLLCFGR & RCC_PLLCFGR_PLLSRC) == RCC_PLLSOURCE_HSE) {
                /* Get the I2S source clock value */
                vcoinput = (uint32_t)(HSE_VALUE / (uint32_t)(RCC->PLLCFGR &
                                                             RCC_PLLCFGR_PLLM));
            } else {
                /* Get the I2S source clock value */
                vcoinput = (uint32_t)(HSI_VALUE / (uint32_t)(RCC->PLLCFGR &
                                                             RCC_PLLCFGR_PLLM));
            }
...
HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
     ...
     * -------------------------*/
    /* In Case of SAI or I2S Clock Configuration through PLLI2S, PLLI2SN
       division factor is common parameters for both peripherals */
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_I2S) ==
        ...
        /*---------------------- I2S configuration
         * -------------------------------*/
        /* In Case of I2S Clock Configuration through PLLI2S, PLLI2SR must be
          added only for I2S configuration */
        if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_I2S) ==
            (RCC_PERIPHCLK_I2S)) {
            /* check for Parameters */
            assert_param(IS_RCC_PLLI2SR_VALUE(PeriphClkInit->PLLI2S.PLLI2SR));
            /* Configure the PLLI2S division factors */
            /* PLLI2S_VCO = f(VCO clock) = f(PLLI2S clock input) x
             * (PLLI2SN/PLLM) */
            /* I2SCLK = f(PLLI2S clock output) = f(VCO clock) / PLLI2SR */
        ...
        /*---------------------------- SAI configuration
         * -------------------------*/
        /* In Case of SAI Clock Configuration through PLLI2S, PLLI2SQ and
           PLLI2S_DIVQ must be added only for SAI configuration */
        if (((PeriphClkInit->PeriphClockSelection) &
             RCC_PERIPHCLK_SAI_PLLI2S) == (RCC_PERIPHCLK_SAI_PLLI2S)) {
     ...
     * --------------------*/
    /* In Case of SAI, LTDC or CLK48 Clock Configuration through PLLSAI, PLLSAIN
       division factor is common parameters for these peripherals */
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI_PLLSAI) ==
        ...
        /*---------------------------- SAI configuration
         * -------------------------*/
        /* In Case of SAI Clock Configuration through PLLSAI, PLLSAIQ and
           PLLSAI_DIVQ must be added only for SAI configuration */
        if (((PeriphClkInit->PeriphClockSelection) &
             RCC_PERIPHCLK_SAI_PLLSAI) == (RCC_PERIPHCLK_SAI_PLLSAI)) {
            assert_param(IS_RCC_PLLSAIQ_VALUE(PeriphClkInit->PLLSAI.PLLSAIQ));
            assert_param(IS_RCC_PLLSAI_DIVQ_VALUE(PeriphClkInit->PLLSAIDivQ));
            ...
            pllsaip = ((((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIP) >>
                        ...
                        1U)
                       << 1U);
            /* Read PLLSAIR value from PLLSAICFGR register (this value is not
             * need for SAI configuration) */
            pllsair = ((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIR) >>
        ...
        if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_LTDC) ==
            ...
            pllsaip = ((((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIP) >>
                        ...
                        1U)
                       << 1U);
            /* Read PLLSAIQ value from PLLSAICFGR register (this value is not
             * need for SAI configuration) */
            pllsaiq = ((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIQ) >>
                       RCC_PLLSAICFGR_PLLSAIQ_Pos);
            /* PLLSAI_VCO Input  = PLL_SOURCE/PLLM */
            ...
            __HAL_RCC_PLLSAI_CONFIG(PeriphClkInit->PLLSAI.PLLSAIN, pllsaip,
                                    pllsaiq, PeriphClkInit->PLLSAI.PLLSAIR);
        ...
        if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_CLK48) ==
            ...
            __HAL_RCC_PLLSAI_CONFIG(PeriphClkInit->PLLSAI.PLLSAIN,
                                    PeriphClkInit->PLLSAI.PLLSAIP, pllsaiq,
                                    pllsair);
        }
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
     ...
     * parameter------------*/
    PeriphClkInit->PeriphClockSelection =
        RCC_PERIPHCLK_I2S | RCC_PERIPHCLK_SAI_PLLSAI |
        RCC_PERIPHCLK_SAI_PLLI2S | RCC_PERIPHCLK_LTDC | RCC_PERIPHCLK_TIM |
        RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_CLK48 | RCC_PERIPHCLK_SDIO;
    ...
    PeriphClkInit->PLLSAI.PLLSAIR =
        (uint32_t)((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIR) >>
                   RCC_PLLSAICFGR_PLLSAIR_Pos);
    PeriphClkInit->PLLSAI.PLLSAIQ =
        (uint32_t)((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIQ) >>
                   RCC_PLLSAICFGR_PLLSAIQ_Pos);
    ...
    PeriphClkInit->PLLSAIDivR =
        (uint32_t)(RCC->DCKCFGR & RCC_DCKCFGR_PLLSAIDIVR);
    /* Get the RTC Clock configuration
     * -----------------------------------------*/
    tempreg = (RCC->CFGR & RCC_CFGR_RTCPRE);
    PeriphClkInit->RTCClockSelection =
...
HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
     ...
     * -----------------------*/
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAIA) ==
        (RCC_PERIPHCLK_SAIA)) {
        /* Check the parameters */
     ...
     * ------------------------*/
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAIB) ==
        (RCC_PERIPHCLK_SAIB)) {
        /* Check the parameters */
    ...
    /*-------------------------------------- PLLI2S Configuration
     * --------------*/
    /* PLLI2S is configured when a peripheral will use it as source clock : I2S
       on APB1 or I2S on APB2*/
    if ((plli2sused == 1U) ||
        (PeriphClkInit->PeriphClockSelection == RCC_PERIPHCLK_PLLI2S)) {
        /* Disable the PLLI2S */
        __HAL_RCC_PLLI2S_DISABLE();
        ...
        if (((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAIA) ==
              RCC_PERIPHCLK_SAIA) &&
             (PeriphClkInit->SaiAClockSelection ==
              RCC_SAIACLKSOURCE_PLLI2SR)) ||
            ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAIB) ==
              RCC_PERIPHCLK_SAIB) &&
             (PeriphClkInit->SaiBClockSelection ==
            ...
            /* Read PLLI2SQ value from PLLI2SCFGR register (this value is not
             * needed for SAI configuration) */
            plli2sq = ((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SQ) >>
                       RCC_PLLI2SCFGR_PLLI2SQ_Pos);
            /* Configure the PLLI2S division factors */
            ...
            /* SAI_CLK(first level) = PLLI2S_VCO Output/PLLI2SQ */
            __HAL_RCC_PLLI2S_CONFIG(PeriphClkInit->PLLI2S.PLLI2SM,
                                    PeriphClkInit->PLLI2S.PLLI2SN, plli2sq,
                                    PeriphClkInit->PLLI2S.PLLI2SR);
     ...
     * -------------------*/
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_DFSDM2) ==
        RCC_PERIPHCLK_DFSDM2) {
        /* Check the parameters */
        assert_param(
            IS_RCC_DFSDM2CLKSOURCE(PeriphClkInit->Dfsdm2ClockSelection));
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_DFSDM2_AUDIO) ==
        ...
        /* Check the parameters */
        assert_param(IS_RCC_DFSDM2AUDIOCLKSOURCE(
            PeriphClkInit->Dfsdm2AudioClockSelection));
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
...
#if defined(STM32F413xx) || defined(STM32F423xx)
    PeriphClkInit->PeriphClockSelection =
        RCC_PERIPHCLK_I2S_APB1 | RCC_PERIPHCLK_I2S_APB2 | RCC_PERIPHCLK_TIM |
        ...
        RCC_PERIPHCLK_DFSDM2 | RCC_PERIPHCLK_DFSDM2_AUDIO |
    ...
    PeriphClkInit->PLLI2SDivR =
        (uint32_t)((RCC->DCKCFGR & RCC_DCKCFGR_PLLI2SDIVR) >>
                   RCC_DCKCFGR_PLLI2SDIVR_Pos);
    PeriphClkInit->PLLDivR = (uint32_t)((RCC->DCKCFGR & RCC_DCKCFGR_PLLDIVR) >>
 ...
 * @param  PeriphClkInit pointer to an RCC_PeriphCLKInitTypeDef structure that
 *         contains the configuration information for the Extended Peripherals
 * clocks(I2S and RTC clocks).
 *
 * @note   A caution to be taken when HAL_RCCEx_PeriphCLKConfig() is used to
 * select RTC clock selection, in this case the Reset of Backup domain will be
 * applied in order to modify the RTC Clock source as consequence all backup
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
    ...
    /* Set all possible values for the extended clock type
     * parameter------------*/
    PeriphClkInit->PeriphClockSelection = RCC_PERIPHCLK_FMPI2C1 |
                                          RCC_PERIPHCLK_LPTIM1 |
...
HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
    ...
    /*----------------------- Common configuration SAI/LTDC
     * --------------------*/
    /* In Case of SAI or LTDC Clock Configuration through PLLSAI, PLLSAIN
       division factor is common parameters for both peripherals */
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI_PLLSAI) ==
         RCC_PERIPHCLK_SAI_PLLSAI) ||
        (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_LTDC) ==
        ...
        if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_LTDC) ==
            ...
            /* Read PLLSAIR value from PLLSAICFGR register (this value is not
             * need for SAI configuration) */
            tmpreg1 = ((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIQ) >>
                       RCC_PLLSAICFGR_PLLSAIQ_Pos);
            /* PLLSAI_VCO Input  = PLL_SOURCE/PLLM */
            /* PLLSAI_VCO Output = PLLSAI_VCO Input * PLLSAIN */
            /* LTDC_CLK(first level) = PLLSAI_VCO Output/PLLSAIR */
...
HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
    ...
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_I2S) ==
         ...
         */
        /* I2SCLK = f(PLLI2S clock output) = f(VCO clock) / PLLI2SR */
        __HAL_RCC_PLLI2S_I2SCLK_CONFIG(PeriphClkInit->PLLI2S.PLLI2SM,
                                       PeriphClkInit->PLLI2S.PLLI2SN,
                                       PeriphClkInit->PLLI2S.PLLI2SR);
#else
        /* Configure the PLLI2S division factors */
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLLI2S(RCC_PLLI2SInitTypeDef *PLLI2SInit) {
    ...
    __HAL_RCC_PLLI2S_CONFIG(PLLI2SInit->PLLI2SM, PLLI2SInit->PLLI2SN,
                            PLLI2SInit->PLLI2SP, PLLI2SInit->PLLI2SQ,
                            PLLI2SInit->PLLI2SR);
    ...
    /* I2SQCLK = PLLI2S_VCO / PLLI2SQ */
    /* I2SRCLK = PLLI2S_VCO / PLLI2SR */
    __HAL_RCC_PLLI2S_SAICLK_CONFIG(PLLI2SInit->PLLI2SN, PLLI2SInit->PLLI2SQ,
                                   PLLI2SInit->PLLI2SR);
#elif defined(STM32F411xE)
    /* PLLI2S_VCO = f(VCO clock) = f(PLLI2S clock input) * (PLLI2SN/PLLI2SM) */
    /* I2SRCLK = PLLI2S_VCO / PLLI2SR */
    __HAL_RCC_PLLI2S_I2SCLK_CONFIG(PLLI2SInit->PLLI2SM, PLLI2SInit->PLLI2SN,
                                   PLLI2SInit->PLLI2SR);
#else
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLLSAI(RCC_PLLSAIInitTypeDef *PLLSAIInit) {
    ...
    /* SAIQCLK = PLLSAI_VCO / PLLSAIQ */
    /* SAIRCLK = PLLSAI_VCO / PLLSAIR */
    __HAL_RCC_PLLSAI_CONFIG(PLLSAIInit->PLLSAIN, PLLSAIInit->PLLSAIQ,
                            PLLSAIInit->PLLSAIR);
#endif /* STM32F446xx */
 ...
 * HSE_VALUE(**)
 * @note     If SYSCLK source is PLL or PLLR, function returns values based on
 * HSE_VALUE(**) or HSI_VALUE(*) multiplied/divided by the PLL factors.
 * @note     (*) HSI_VALUE is a constant defined in stm32f4xx_hal_conf.h file
 * (default value 16 MHz) but the real value may vary depending on the
 * variations in voltage and temperature.
 * @note     (**) HSE_VALUE is a constant defined in stm32f4xx_hal_conf.h file
...
HAL_StatusTypeDef HAL_RCC_DeInit(void) {
    ...
    /* Once PLL, PLLI2S and PLLSAI are OFF, reset PLLCFGR register to default
     * value */
    ...
    RCC->PLLCFGR = RCC_PLLCFGR_PLLM_4 | RCC_PLLCFGR_PLLN_6 |
                   RCC_PLLCFGR_PLLN_7 | RCC_PLLCFGR_PLLQ_2 | RCC_PLLCFGR_PLLR_1;
#elif defined(STM32F410Tx) || defined(STM32F410Cx) || defined(STM32F410Rx)
    RCC->PLLCFGR = RCC_PLLCFGR_PLLR_0 | RCC_PLLCFGR_PLLR_1 |
                   RCC_PLLCFGR_PLLR_2 | RCC_PLLCFGR_PLLM_4 |
                   RCC_PLLCFGR_PLLN_6 | RCC_PLLCFGR_PLLN_7 |
                   RCC_PLLCFGR_PLLQ_0 | RCC_PLLCFGR_PLLQ_1 |
                   RCC_PLLCFGR_PLLQ_2 | RCC_PLLCFGR_PLLQ_3;
#else
    RCC->PLLCFGR = RCC_PLLCFGR_PLLM_4 | RCC_PLLCFGR_PLLN_6 |
                   RCC_PLLCFGR_PLLN_7 | RCC_PLLCFGR_PLLQ_2;
#endif /* STM32F412Cx || STM32F412Rx || STM32F412Vx || STM32F412Zx ||          \
          STM32F413xx || STM32F423xx || STM32F446xx || STM32F469xx ||          \
          STM32F479xx */
...
#endif /* STM32F412Cx || STM32F412Rx || STM32F412Vx || STM32F412Zx ||          \
          STM32F413xx || STM32F423xx || STM32F446xx */
    ...
    CLEAR_BIT(RCC->CIR, RCC_CIR_LSIRDYIE | RCC_CIR_LSERDYIE | RCC_CIR_HSIRDYIE |
                            RCC_CIR_HSERDYIE | RCC_CIR_PLLRDYIE);
    ...
    SET_BIT(RCC->CIR, RCC_CIR_LSIRDYC | RCC_CIR_LSERDYC | RCC_CIR_HSIRDYC |
 ...
 * @note   This function add the PLL/PLLR factor management during PLL
 * configuration this feature is only available in
