/**
  ...
  *
  ...
  FLASH memory of all STM32F4xx devices.
 ...
 * procedure Mass Erase: Bank number which has been requested to erase Sectors
 * Erase: Sector which has been erased (if 0xFFFFFFFFU, it means that all the
 * selected sectors have been erased) Program: Address which was selected for
 * data program
 * @retval None
 */
 ...
 * @param  ReturnValue The value saved in this parameter depends on the ongoing
 * procedure Mass Erase: Bank number which has been requested to erase Sectors
 * Erase: Sector number which returned an error Program: Address which was
