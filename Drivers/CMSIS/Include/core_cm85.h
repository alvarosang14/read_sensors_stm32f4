...
typedef union {
    struct {
        ...
        uint32_t BTI_EN : 1;  /*!< bit:      4  Privileged branch target
                                 identification enable */
        uint32_t UBTI_EN : 1; /*!< bit:      5  Unprivileged branch target
                                 identification enable */
        uint32_t PAC_EN : 1; /*!< bit:      6  Privileged pointer authentication
                                enable */
        uint32_t UPAC_EN : 1;     /*!< bit:      7  Unprivileged pointer
...
#define CONTROL_UPAC_EN_Msk                                                    \
    (1UL << CONTROL_UPAC_EN_Pos) /*!< CONTROL: UPAC_EN Mask */

#define CONTROL_PAC_EN_Pos 6U /*!< CONTROL: PAC_EN Position */
#define CONTROL_PAC_EN_Msk                                                     \
    (1UL << CONTROL_PAC_EN_Pos) /*!< CONTROL: PAC_EN Mask */

#define CONTROL_UBTI_EN_Pos 5U /*!< CONTROL: UBTI_EN Position */
#define CONTROL_UBTI_EN_Msk                                                    \
    (1UL << CONTROL_UBTI_EN_Pos) /*!< CONTROL: UBTI_EN Mask */

#define CONTROL_BTI_EN_Pos 4U /*!< CONTROL: BTI_EN Position */
#define CONTROL_BTI_EN_Msk                                                     \
    (1UL << CONTROL_BTI_EN_Pos) /*!< CONTROL: BTI_EN Mask */
...
#define ARMCM85_PMU_ECC_ERR_DTCM                                               \
    0xC020 /*!< One or more ECC errors in the Data Tightly Coupled Memory      \
              (DTCM) */
#define ARMCM85_PMU_ECC_ERR_ITCM                                               \
    0xC021 /*!< One or more ECC errors in the Instruction Tightly Coupled      \
              Memory (ITCM) */
...
#define ARMCM85_PMU_PF_LINEFILL                                                \
    0xC100                           /*!< The prefetcher starts a line-fill    \
                                      */
