...
typedef struct {
    ...
    __OM uint32_t STIR; /*!< Offset: F00-D00=0x200 ( /W)  Software Triggered
                           Interrupt Register */
...
typedef struct {
    ...
    __IOM uint32_t ITCMCR; /*!< Offset: 0x10 (R/W)  Instruction Tightly-Coupled
                              Memory Control Register */
    __IOM uint32_t DTCMCR; /*!< Offset: 0x14 (R/W)  Data Tightly-Coupled Memory
                              Control Registers */
} EMSS_Type;
...
#define SCB_DCISW_LEVEL_Msk                                                    \
    (7UL << SCB_DCISW_LEVEL_Pos) /*!< SCB DCISW: Level Mask */
...
#define SCB_DCISW_SET_Msk                                                      \
    (0xFFUL << SCB_DCISW_SET_Pos) /*!< SCB DCISW: Set Mask */

/* SCB D-Cache Clean line by Set-way Register Definitions */
#define SCB_DCCSW_LEVEL_Pos 1U /*!< SCB DCCSW: Level Position */
#define SCB_DCCSW_LEVEL_Msk                                                    \
    (7UL << SCB_DCCSW_LEVEL_Pos) /*!< SCB DCCSW: Level Mask */
...
#define SCB_DCCSW_SET_Msk                                                      \
    (0xFFUL << SCB_DCCSW_SET_Pos) /*!< SCB DCCSW: Set Mask */

/* SCB D-Cache Clean and Invalidate by Set-way Register Definitions */
#define SCB_DCCISW_LEVEL_Pos 1U /*!< SCB DCCISW: Level Position */
#define SCB_DCCISW_LEVEL_Msk                                                   \
    (7UL << SCB_DCCISW_LEVEL_Pos) /*!< SCB DCCISW: Level Mask */
...
#define SCB_DCCISW_SET_Msk                                                     \
    (0xFFUL << SCB_DCCISW_SET_Pos) /*!< SCB DCCISW: Set Mask */
...
#define SCB_CACR_DCCLEAN_Msk                                                   \
    (1UL << SCB_CACR_FORCEWT_Pos) /*!< SCB CACR: DCCLEAN Mask */
...
__NO_RETURN __STATIC_INLINE void __SW_SystemReset(void) {
    ...
    SCB->AIRCR =
        (uint32_t)((0x5FAUL << SCB_AIRCR_VECTKEY_Pos) |
                   (SCB->AIRCR &
                    SCB_AIRCR_BFHFNMINS_Msk) | /* Keep BFHFNMINS unchanged. Use
                                                  this Reset function in case
                                                  your case need to keep it */
                   (SCB->AIRCR & SCB_AIRCR_PRIGROUP_Msk) | /* Keep priority
                                                              group unchanged */
